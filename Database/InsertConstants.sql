...
INSERT INTO  dbo.[Personality] ([personalityId], [personalityNameEN], [personalityNameBM], [descriptionEN], [descriptionBM], [avatar], [colour], [learningStyleEN], [learningStyleBM]) VALUES
...
INSERT INTO  dbo.[Badge] ([badgeId], [badgeNameEN], [badgeNameBM], [badgeType], [xpReward], [badgeIcon], [requirementDescriptionEN], [requirementDescriptionBM], [badgeDescriptionEN], [badgeDescriptionBM]) VALUES
...
INSERT INTO  dbo.[Lesson] ([lessonId], [subtopicId], [lessonTitleEN], [lessonTitleBM], [lessonContentEN], [lessonContentBM], [attachmentUrl], [orderNo]) VALUES
...
(N'LS029', N'ST232', N'Acidic, Alkaline and Neutral Substances Around Us', N'Bahan Asid, Alkali dan Neutral di Sekeliling Kita', N'Many household substances can be classified according to their properties.', N'Banyak bahan di sekeliling kita boleh dikelaskan mengikut sifatnya.', N'Images/Lesson/substances,png', 2),
