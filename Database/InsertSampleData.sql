...
INSERT INTO  dbo.[Teacher] ([teacherId], [userId], [name], [phoneNumber], [academicQualification], [bio], [licenseCert], [status], [approvedDate]) VALUES
...
INSERT INTO  dbo.[Material] ([materialId], [subtopicId], [createdByUserId], [materialTitle], [materialType], [fileUrl], [materialContent], [createdDate], [status], [reviewedDate], [language]) VALUES
...
INSERT INTO  dbo.[Certificate] ([certificateId], [studentId], [levelId], [certificateTitleEN], [certificateTitleBM], [certificateDescriptionEN], [certificateDescriptionBM], [issuedDate], [certificateUrl], [certificateCode], [status]) VALUES
...
INSERT INTO  dbo.[privateMessage] ([privateMsgId], [chatId], [senderUserId], [msgText], [attachmentFile], [sentAt], [isRead], [readAt]) VALUES
