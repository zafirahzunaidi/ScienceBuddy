...
<asp:Content ID="cSidebar" ContentPlaceHolderID="SidebarMenu" runat="server">
    ...
    <div class="sb-nav-section">
        ...
        <a href="<%: ResolveUrl("~/Teacher/Forum.aspx") %>" class="sb-sidebar-item active">
...
<asp:Content ID="cPageTitle" ContentPlaceHolderID="PageTitle" runat="server">
    <%: T("Forum Discussion","Perbincangan Forum") %>
</asp:Content>
...
<asp:Content ID="cMain" ContentPlaceHolderID="MainContentSidebar" runat="server">
    ...
    <asp:Panel ID="pnlError" runat="server" Visible="false">
        <div class="tc-forum-reply-err-card">
            ...
            <div class="tc-forum-reply-err-title">
                <%: T("Discussion Not Found","Perbincangan Tidak Dijumpai") %>
            </div>
            <div class="tc-forum-reply-err-sub">
        ...
        <div class="tc-forum-reply-layout">
            ...
            <div class="tc-forum-reply-left-col">
                ...
                <div class="tc-forum-reply-main-card">
                    <div class="tc-forum-reply-card-top">
                        <div class="tc-forum-reply-avatar-lg">
                        ...
                        <div class="tc-forum-reply-creator-info">
                            ...
                            <div class="tc-forum-reply-date">
                                <i class="bi bi-clock"></i>
                                <asp:Literal ID="litPostDate" runat="server" />
                            </div>
                        </div>
                    </div>

                    <div class="tc-forum-reply-post-title">
                        <asp:Literal ID="litTitle" runat="server" />
                    </div>
                    <div class="tc-forum-reply-post-msg">
                        <asp:Literal ID="litMessage" runat="server" />
                    </div>

                    <div class="tc-forum-reply-main-footer">
                        <span class="tc-forum-reply-stat">
                            <i class="bi bi-chat-text"></i>
                            <asp:Literal ID="litReplyCount" runat="server" /> <%: T("replies","balasan") %>
                        </span>
                ...
                <div id="frdPendingNotice" class="tc-forum-reply-pending-notice" style="display:none;">
                    <div class="tc-forum-reply-pending-notice-icon">
                        <i class="bi bi-shield-exclamation"></i>
                    </div>
                    <div class="tc-forum-reply-pending-notice-content">
                        <div class="tc-forum-reply-pending-notice-title">
                            <%: T("Verification Pending","Pengesahan Menunggu") %>
                        </div>
                        <div class="tc-forum-reply-pending-notice-msg">
                            <%: T("Your Teaching License is still under review. Replying to forum discussions is temporarily unavailable until your verification has been approved.","Lesen Mengajar anda masih dalam semakan. Membalas perbincangan forum tidak tersedia buat sementara waktu sehingga pengesahan anda diluluskan.") %>
                        </div>
                    </div>
                </div>
                ...
                <div class="tc-forum-reply-composer-wrap">
                    <div class="tc-forum-reply-composer-row">
                        <asp:TextBox ID="txtReply" runat="server"
                            CssClass="tc-forum-reply-composer-ta"
                            TextMode="MultiLine"
                            Rows="1"
                            placeholder="Write a reply..." />
                        <asp:LinkButton ID="btnPostReply" runat="server"
                            CssClass="tc-forum-reply-send-btn"
                    ...
                    <asp:Panel ID="pnlReplyVal" runat="server" Visible="false" CssClass="tc-forum-reply-composer-val">
                        <span class="tc-forum-reply-val-msg">
                            <i class="bi bi-exclamation-circle-fill"></i>
                            <asp:Literal ID="litReplyVal" runat="server" />
                        </span>
                    </asp:Panel>
                </div>
                ...
                <div class="tc-forum-reply-comments-hd">
                    ...
                    <span class="tc-forum-reply-count-badge">
                        <asp:Literal ID="litRepliesBadge" runat="server" />
                    </span>
                </div>
                            ...
                            <ItemTemplate>
                                <div class='tc-forum-reply-reply accent-<%# Eval("roleCss") %>'>
                                    <div class="tc-forum-reply-reply-top">
                                        <div class="tc-forum-reply-avatar-sm">
                                            <%# Eval("initials") %>
                                        </div>
                                        <div class="tc-forum-reply-reply-meta">
                                            <div class="tc-forum-reply-reply-name">
                                                <%# HttpUtility.HtmlEncode(Eval("senderName").ToString()) %>
                                                <span class='tc-forum-reply-role-badge <%# Eval("roleCss") %>'>
                                                    <%# Eval("roleLabel") %>
                                                </span>
                                            </div>
                                            <div class="tc-forum-reply-reply-date">
                                                <i class="bi bi-clock"></i> <%# Eval("timeAgo") %>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tc-forum-reply-reply-msg">
            ...
            <div class="tc-forum-reply-sidebar">
                <div class="tc-forum-reply-sidebar-card">
                    <div class="tc-forum-reply-sidebar-title">
                        <i class="bi bi-collection" style="color:var(--tp);"></i>
                        <%: T("More Discussions","Perbincangan Lain") %>
                    </div>
                            ...
                            <asp:Repeater ID="rptMore" runat="server">
                                <ItemTemplate>
                                    <div class='tc-forum-reply-more-item accent-<%# Eval("roleCss") %>'>
                                        <div class="tc-forum-reply-more-avatar">
                                            <%# Eval("initials") %>
                                        </div>
                                        <div class="tc-forum-reply-more-info">
                                            <div class="tc-forum-reply-more-name">
                                                <%# HttpUtility.HtmlEncode(Eval("creatorName").ToString()) %>
                                            </div>
                                            <div class="tc-forum-reply-more-date">
                                                <%# Eval("timeAgo") %>
                                            </div>
                                            <div class="tc-forum-reply-more-title">
        ...
        (function () {
            ...
            if (ta) {
                ta.addEventListener('focus', function () {
                    ...
                    this.style.boxShadow = '0 0 0 3px rgba(108,99,255,.08)';
                });
