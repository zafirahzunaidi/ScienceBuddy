...
<asp:Content ID="cPageTitle" ContentPlaceHolderID="PageTitle" runat="server">
    <%: T("Upload Material","Muat Naik Bahan") %>
</asp:Content>
...
<asp:Content ID="cMain" ContentPlaceHolderID="MainContentSidebar" runat="server">
    ...
    <%-- Back Link --%>
    <a href="<%: ResolveUrl("~/Teacher/manageMaterials.aspx") %>" class="tc-upload-material-back">
        <i class="bi bi-arrow-left"></i> <%: T("Back to Materials","Kembali ke Bahan") %>
    </a>

    <%-- Page Header --%>
    <div class="tc-upload-material-header">
        <h1>
            <i class="bi bi-cloud-arrow-up" style="color:var(--p);margin-right:.3rem;"></i>
            <%: T("Upload Material","Muat Naik Bahan") %>
        </h1>
        <p><%: T("Upload a new learning material for your students.","Muat naik bahan pembelajaran baharu untuk pelajar.") %></p>
    </div>
    ...
    <div class="tc-upload-material-card">
        ...
        <asp:Panel ID="pnlError" runat="server" Visible="false">
            <div class="tc-upload-material-error">
        ...
        <div class="tc-upload-material-row-full">
            <div class="tc-upload-material-field">
                ...
                <asp:TextBox ID="txtTitle" runat="server"
                    MaxLength="150"
                    CssClass="tc-upload-material-input"
                    placeholder="Enter material title..." />
                <div class="tc-upload-material-val" id="vTitle">
                    <%: T("Material Title is required.","Tajuk Bahan diperlukan.") %>
                </div>
            </div>
        </div>
        ...
        <div class="tc-upload-material-row-full">
            <div class="tc-upload-material-field">
                ...
                <asp:TextBox ID="txtDescription" runat="server"
                    TextMode="MultiLine"
                    Rows="4"
                    CssClass="tc-upload-material-input tc-upload-material-textarea"
                ...
                <div class="tc-upload-material-rte-wrap" id="rteWrap">
                    <div class="tc-upload-material-rte-toolbar" id="rteToolbar">
                        <button type="button" class="tc-upload-material-rte-btn" id="rteBold"
                            title="Bold (Ctrl+B)" onclick="rteCmd('bold')">
                            <i class="bi bi-type-bold"></i>
                        </button>
                        <button type="button" class="tc-upload-material-rte-btn" id="rteItalic"
                            title="Italic (Ctrl+I)" onclick="rteCmd('italic')">
                            <i class="bi bi-type-italic"></i>
                        </button>
                        <button type="button" class="tc-upload-material-rte-btn" id="rteUnder"
                            title="Underline (Ctrl+U)" onclick="rteCmd('underline')">
                            <i class="bi bi-type-underline"></i>
                        </button>
                        <div class="tc-upload-material-rte-sep"></div>
                        <button type="button" class="tc-upload-material-rte-btn" id="rteBullet"
                            title="Bulleted List" onclick="rteCmd('insertUnorderedList')">
                            <i class="bi bi-list-ul"></i>
                        </button>
                        <button type="button" class="tc-upload-material-rte-btn" id="rteNumber"
                            title="Numbered List" onclick="rteCmd('insertOrderedList')">
                            <i class="bi bi-list-ol"></i>
                        </button>
                    </div>
                    <div class="tc-upload-material-rte-editor" id="rteEditor"
                        contenteditable="true"
                        data-placeholder="Describe what this material covers...">
                    </div>
                </div>
            </div>
        </div>

        <%-- Row 3: Language + Level + Unit + Subtopic (UpdatePanel for cascading) --%>
            ...
            <ContentTemplate>
                <div class="tc-upload-material-row-3col">
                    ...
                    <div class="tc-upload-material-field">
                        ...
                        <div class="tc-upload-material-val" id="vLevel">
                            <%: T("Select Level.","Pilih Tahap.") %>
                        </div>
                    </div>
                    ...
                    <div class="tc-upload-material-field">
                        ...
                        <div class="tc-upload-material-val" id="vUnit">
                            <%: T("Select Unit.","Pilih Unit.") %>
                        </div>
                    </div>
                    ...
                    <div class="tc-upload-material-field">
                        ...
                        <asp:DropDownList ID="ddlSubtopic" runat="server"
                            CssClass="tc-upload-material-input" />
                        <div class="tc-upload-material-val" id="vSub">
        ...
        <div class="tc-upload-material-row-full">
            <div class="tc-upload-material-field">
                ...
                <div class="tc-upload-material-drop" id="dropZone"
                    onclick="document.getElementById('<%=fuFile.ClientID%>').click();">
                ...
                <div class="tc-upload-material-file-card" id="fileCard" style="display:none;">
                    <div class="tc-upload-material-file-ico" id="fIco">
                        <i class="bi bi-file-earmark-fill"></i>
                    </div>
                    <div class="tc-upload-material-file-info">
                        <span class="tc-upload-material-file-name" id="fName"></span>
                        <span class="tc-upload-material-file-meta" id="fMeta"></span>
                    </div>
                    <button type="button" class="tc-upload-material-file-rm" onclick="removeFile(event)">
                        <i class="bi bi-x-lg"></i>
                    </button>
                </div>

                <div class="tc-upload-material-val" id="vFile">
                    <%: T("Please upload a file.","Sila muat naik fail.") %>
                </div>
        ...
        <div class="tc-upload-material-actions">
            <a href="<%: ResolveUrl("~/Teacher/manageMaterials.aspx") %>"
                class="tc-upload-material-btn tc-upload-material-btn-cancel">
                <%: T("Cancel","Batal") %>
            </a>
            <button type="button"
                class="tc-upload-material-btn tc-upload-material-btn-primary"
                onclick="validateForm()">
                <i class="bi bi-cloud-arrow-up"></i> <%: T("Upload Material","Muat Naik Bahan") %>
            </button>
        </div>
    ...
    <div id="confirmModal" class="tc-upload-material-modal-overlay" style="display:none;">
        <div class="tc-upload-material-modal">
            <div class="tc-upload-material-modal-hd">
                <h3><%: T("Confirm Upload","Sahkan Muat Naik") %></h3>
                <button type="button" class="tc-upload-material-modal-close"
                    onclick="closeModal()">&#215;</button>
            </div>
            <div class="tc-upload-material-modal-body">
                <p><%: T("Upload this material?","Muat naik bahan ini?") %></p>
            </div>
            <div class="tc-upload-material-modal-ft">
                ...
                <asp:Button ID="btnUpload" runat="server"
                    ...
                    CssClass="tc-upload-material-btn tc-upload-material-btn-primary" />
            </div>
        </div>
    </div>
    ...
    <div class="tc-upload-material-unsaved-overlay" id="umUnsavedOverlay">
        <div class="tc-upload-material-unsaved-modal">
            <div class="tc-upload-material-unsaved-icon">
            ...
            <div class="tc-upload-material-unsaved-actions">
                <button type="button" class="tc-upload-material-unsaved-cancel"
                    onclick="document.getElementById('umUnsavedOverlay').classList.remove('open')">
                    <%: T("Cancel","Batal") %>
                </button>
                <button type="button" class="tc-upload-material-unsaved-confirm" id="umUnsavedConfirm">
                    <%: T("Confirm","Sahkan") %>
                </button>
            </div>
        </div>
...
<script>
    ...
    function setLang(v) {
        document.getElementById('<%=hidLanguage.ClientID%>').value = v;
    ...
    function handleFile(inp) {
        ...
        ico.className = 'tc-upload-material-file-ico ' + getIcoCss(ext);
    ...
    function getIcoCss(x) {
        if (x === 'pdf') return 'tc-upload-material-ico-pdf';
        if (x === 'doc' || x === 'docx') return 'tc-upload-material-ico-doc';
        if (x === 'ppt' || x === 'pptx') return 'tc-upload-material-ico-ppt';
        if (x === 'jpg' || x === 'jpeg' || x === 'png') return 'tc-upload-material-ico-img';
        if (x === 'mp4') return 'tc-upload-material-ico-vid';
        return 'tc-upload-material-ico-oth';
    }

    function getIcoClass(x) {
        if (x === 'pdf') return 'bi-file-earmark-pdf-fill';
        if (x === 'doc' || x === 'docx') return 'bi-file-earmark-word-fill';
        if (x === 'ppt' || x === 'pptx') return 'bi-file-earmark-slides-fill';
        if (x === 'jpg' || x === 'jpeg' || x === 'png') return 'bi-file-earmark-image-fill';
        if (x === 'mp4') return 'bi-file-earmark-play-fill';
    ...
    function validateForm() {
        ...
        syncRteToTextarea();
        var ok = true;
        var t = document.querySelector('[id$="txtTitle"]');
        if (!t.value.trim()) { show('vTitle'); t.classList.add('invalid'); ok = false; } else { hide('vTitle'); t.classList.remove('invalid'); }
        var u = document.querySelector('[id$="ddlUnit"]');
        if (!u.value) { show('vUnit'); u.classList.add('invalid'); ok = false; } else { hide('vUnit'); u.classList.remove('invalid'); }
        var lv = document.querySelector('[id$="ddlLevel"]');
        if (!lv.value) { show('vLevel'); lv.classList.add('invalid'); ok = false; } else { hide('vLevel'); lv.classList.remove('invalid'); }
        var s = document.querySelector('[id$="ddlSubtopic"]');
        if (!s.value) { show('vSub'); s.classList.add('invalid'); ok = false; } else { hide('vSub'); s.classList.remove('invalid'); }
    ...
    if (dz) {
        ...
        dz.addEventListener('drop', function (e) {
            ...
            if (dt.files && dt.files[0]) {
                var inp = document.getElementById('<%=fuFile.ClientID%>');
                inp.files = dt.files;
                handleFile(inp);
            }
        });
    ...
    window.addEventListener('load', function () {
        ...
        if (h && h.value) {
            ...
            t.className = 'tc-upload-material-toast';
            t.innerHTML = '<i class="bi bi-check-circle-fill"></i> ' + h.value;
            w.appendChild(t);
            h.value = '';
            setTimeout(function () { t.style.opacity = '0'; t.style.transition = 'opacity .3s'; }, 3e3);
            setTimeout(function () { t.remove(); }, 3500);
            /* Reset language buttons and file UI after successful upload */
            setLang('EN');
            fileOk = false;
            document.getElementById('dropZone').style.display = 'block';
            document.getElementById('fileCard').style.display = 'none';
