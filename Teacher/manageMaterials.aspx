...
<div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:1rem;flex-wrap:wrap;gap:.75rem;">
    ...
    <asp:Panel ID="pnlUploadBtn" runat="server">
        ...
        <asp:Panel ID="pnlUploadEnabled" runat="server">
            <a href="<%: ResolveUrl("~/Teacher/uploadMaterial.aspx") %>" class="tc-manage-materials-btn-upload"><i class="bi bi-plus-lg"></i> <%: T("Upload Material","Muat Naik Bahan") %></a>
        </asp:Panel>
        <%-- Shown when Pending --%>
        <asp:Panel ID="pnlUploadDisabled" runat="server" Visible="false">
            <button type="button" class="tc-manage-materials-btn-upload-disabled" disabled
...
<div class="tc-manage-materials-tabs">
    <asp:LinkButton ID="btnTabMine" runat="server" CssClass="tc-manage-materials-tab active" OnClick="btnTabMine_Click" CausesValidation="false"><i class="bi bi-folder2-open"></i> <%: T("My Materials","Bahan Saya") %></asp:LinkButton>
    <asp:LinkButton ID="btnTabDiscover" runat="server" CssClass="tc-manage-materials-tab" OnClick="btnTabDiscover_Click" CausesValidation="false"><i class="bi bi-globe2"></i> <%: T("Discover Materials","Terokai Bahan") %></asp:LinkButton>
</div>
...
<div class="tc-manage-materials-filter-bar">
    ...
    <asp:DropDownList ID="ddlFilterLevel" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlFilterLevel_Changed" CssClass="tc-manage-materials-select" />
    <asp:DropDownList ID="ddlFilterUnit" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlFilterUnit_Changed" CssClass="tc-manage-materials-select" />
    <asp:DropDownList ID="ddlFilterType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlFilterType_Changed" CssClass="tc-manage-materials-select" />
    <asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click" CausesValidation="false" CssClass="tc-manage-materials-btn-search" />
</div>
</asp:Panel>
...
<div class="tc-manage-materials-chips">
    <asp:LinkButton ID="btnChipAll" runat="server" CssClass="tc-manage-materials-chip active" OnClick="btnChip_Click" CommandArgument="" CausesValidation="false" data-status="all"><%: T("All","Semua") %></asp:LinkButton>
    <asp:LinkButton ID="btnChipApproved" runat="server" CssClass="tc-manage-materials-chip" OnClick="btnChip_Click" CommandArgument="Approved" CausesValidation="false" data-status="approved"><%: T("Approved","Diluluskan") %></asp:LinkButton>
    <asp:LinkButton ID="btnChipPending" runat="server" CssClass="tc-manage-materials-chip" OnClick="btnChip_Click" CommandArgument="Pending" CausesValidation="false" data-status="pending"><%: T("Pending","Menunggu") %></asp:LinkButton>
    <asp:LinkButton ID="btnChipRejected" runat="server" CssClass="tc-manage-materials-chip" OnClick="btnChip_Click" CommandArgument="Rejected" CausesValidation="false" data-status="rejected"><%: T("Rejected","Ditolak") %></asp:LinkButton>
</div>
</asp:Panel>
        ...
        <ItemTemplate>
            <div class="tc-manage-materials-card">
                <div class="tc-manage-materials-card-top">
                    ...
                    <span class='tc-manage-materials-badge <%# GetStatusCss(Eval("status").ToString()) %>'><%# HttpUtility.HtmlEncode(Eval("status")) %></span>
                </div>
                <div class="tc-manage-materials-card-actions">
                    <button type="button" class="tc-manage-materials-action-btn tc-manage-materials-act-view" onclick="openViewModal(this)"
                    ...
                    <asp:LinkButton ID="lnkDownload" runat="server" CommandName="DownloadMaterial" CommandArgument='<%# Eval("fileUrl") %>' CssClass="tc-manage-materials-action-btn tc-manage-materials-act-download" CausesValidation="false"><i class="bi bi-download"></i> Download</asp:LinkButton>
                    ...
                    <button type="button" class="tc-manage-materials-action-btn tc-manage-materials-act-delete" onclick="openDeleteModal('<%# Eval("materialId") %>','<%# HttpUtility.JavaScriptStringEncode(Eval("materialTitle").ToString()) %>')"><i class="bi bi-trash"></i> Delete</button>
                </div>
            </div>
        </ItemTemplate>
    </asp:Repeater>
        ...
        <ItemTemplate>
            <div class="tc-manage-materials-card">
                <div class="tc-manage-materials-card-top">
                    ...
                    <div class="tc-manage-materials-card-info">
                        <div class="tc-manage-materials-card-title"><%# HttpUtility.HtmlEncode(Eval("materialTitle")) %></div>
                        <div class="tc-manage-materials-card-teacher"><i class="bi bi-person"></i> <%# HttpUtility.HtmlEncode(Eval("teacherName")) %></div>
                        <div class="tc-manage-materials-card-desc"><%# (Eval("materialContent")?.ToString() ?? "").Length > 250 ? "<span class='tc-manage-materials-desc-short'>" + HttpUtility.HtmlEncode((Eval("materialContent")?.ToString() ?? "").Substring(0,250)) + "...</span><span class='tc-manage-materials-desc-full'>" + HttpUtility.HtmlEncode(Eval("materialContent")?.ToString() ?? "") + "</span>" : HttpUtility.HtmlEncode(Eval("materialContent")?.ToString() ?? "") %></div>
                        <%# (Eval("materialContent")?.ToString() ?? "").Length > 250 ? "<span class='tc-manage-materials-view-more' onclick='toggleDesc(this)'>View More</span>" : "" %>
                        <div class="tc-manage-materials-card-meta">
                            <span><i class="bi bi-folder2-open"></i> <%# HttpUtility.HtmlEncode(Eval("subtopicName")) %></span>
                ...
                <div class="tc-manage-materials-card-actions">
                    ...
                    <asp:LinkButton ID="lnkDownloadD" runat="server" CommandName="DownloadMaterial" CommandArgument='<%# Eval("fileUrl") %>' CssClass="tc-manage-materials-action-btn tc-manage-materials-act-download" CausesValidation="false"><i class="bi bi-download"></i> <%: T("Download","Muat Turun") %></asp:LinkButton>
                </div>
            </div>
        </ItemTemplate>
    </asp:Repeater>
...
<div id="editModal" class="tc-manage-materials-modal-overlay" style="display:none;">
    <div class="tc-manage-materials-modal">
        <div class="tc-manage-materials-modal-header">
            <div>
                <h3 class="tc-manage-materials-modal-title"><asp:Literal ID="litFormTitle" runat="server" Text="Edit Material" /></h3>
        ...
        <div class="tc-manage-materials-modal-body">
            ...
            <div class="tc-manage-materials-form-grid2">
                <div>
                    ...
                    <asp:TextBox ID="txtTitle" runat="server" MaxLength="150" CssClass="tc-manage-materials-input" />
            ...
            <div style="margin-bottom:1rem;">
                ...
                <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" Rows="3" CssClass="tc-manage-materials-input" style="resize:vertical;" />
            </div>
            <div class="tc-manage-materials-form-grid3">
                <div>
                    <label class="tc-manage-materials-label">Level *</label>
                    <asp:DropDownList ID="ddlLevel" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlLevel_Changed" CssClass="tc-manage-materials-input" />
                    <div class="tc-manage-materials-val-msg" id="valLevel">Level is required.</div>
                </div>
                <div>
                    <label class="tc-manage-materials-label">Unit *</label>
                    <asp:DropDownList ID="ddlUnit" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlUnit_Changed" CssClass="tc-manage-materials-input" />
                ...
                <div>
                    ...
                    <asp:DropDownList ID="ddlSubtopic" runat="server" CssClass="tc-manage-materials-input" />
            ...
            <div style="margin-bottom:.5rem;">
                ...
                <asp:FileUpload ID="fuFile" runat="server" CssClass="tc-manage-materials-input" style="padding:.4rem .6rem;background:#FAFAFA;" />
        ...
        <div class="tc-manage-materials-modal-footer">
            <button type="button" class="tc-manage-materials-btn-cancel" onclick="closeEditModal()"><%: T("Cancel","Batal") %></button>
            <button type="button" class="tc-manage-materials-btn-primary" id="btnEditConfirmChanges" onclick="validateEditForm()">
...
<div id="deleteConfirmModal" class="tc-manage-materials-modal-overlay" style="display:none;">
    <div class="tc-manage-materials-modal tc-manage-materials-modal-sm" style="border-radius:16px;overflow:hidden;box-shadow:0 20px 60px rgba(0,0,0,.18);">
        ...
        <div style="display:flex;justify-content:flex-end;gap:.6rem;padding:1rem 1.5rem;border-top:1px solid var(--tc-border);">
            <button type="button" class="tc-manage-materials-btn-cancel" onclick="closeDeleteModal()" style="border-radius:10px;"><%: T("Cancel","Batal") %></button>
            <asp:Button ID="btnConfirmDelete" runat="server" Text="Delete" OnClick="btnConfirmDelete_Click" CausesValidation="false"
                CssClass="tc-manage-materials-btn-primary" style="background:#DC2626;border-radius:10px;" />
        </div>
    </div>
</div>
...
<%-- --- VIEW MATERIAL MODAL --- --%>
<div id="viewMaterialModal" class="tc-manage-materials-modal-overlay" style="display:none;" onclick="if(event.target===this)closeViewModal()">
    <div class="tc-manage-materials-modal" style="max-width:780px;max-height:90vh;display:flex;flex-direction:column;border-radius:18px;overflow:hidden;box-shadow:0 24px 64px rgba(0,0,0,.22);">
