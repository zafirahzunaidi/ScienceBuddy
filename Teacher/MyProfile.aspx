...
<asp:Content ID="cSidebar" ContentPlaceHolderID="SidebarMenu" runat="server">
    ...
    <div class="sb-nav-section">
        ...
        <a href="<%: ResolveUrl("~/Teacher/MyProfile.aspx") %>" class="sb-sidebar-item active">
...
<div class="tc-my-profile-hero">
    ...
    <div class="tc-my-profile-avatar">
        ...
        <asp:Panel ID="pnlAvatarVerified" runat="server"
            CssClass="tc-my-profile-avatar-verified"
            Visible="false">
            <i class="bi bi-check-lg"></i>
        </asp:Panel>
    </div>
    <div class="tc-my-profile-hero-info">
        <div class="tc-my-profile-hero-name">
        ...
        <div class="tc-my-profile-hero-meta">
            ...
            <span class="tc-my-profile-badge tc-my-profile-badge-grey">
                <i class="bi bi-hash"></i> <asp:Literal ID="litTeacherId" runat="server" />
            </span>
        </div>
        <div class="tc-my-profile-hero-tagline">
            <%: T("Inspiring young minds to explore, question and discover the world of science.","Menginspirasi minda muda untuk meneroka, menyoal dan menemui dunia sains.") %>
        </div>
...
<div class="tc-my-profile-tabs">
    <button type="button" class="tc-my-profile-tab tc-my-profile-tab-active" onclick="switchTab('personal',this)">
        <i class="bi bi-person-circle"></i> <%: T("Personal Information","Maklumat Peribadi") %>
    </button>
    <button type="button" class="tc-my-profile-tab" onclick="switchTab('certificate',this)">
        <i class="bi bi-file-earmark-check"></i> <%: T("Teaching Certificate","Sijil Pengajaran") %>
    </button>
    <button type="button" class="tc-my-profile-tab" onclick="switchTab('permissions',this)">
        <i class="bi bi-shield-check"></i> <%: T("Teaching Permissions","Kebenaran Pengajaran") %>
    </button>
    <button type="button" class="tc-my-profile-tab" onclick="switchTab('settings',this)">
        <i class="bi bi-gear"></i> <%: T("Account Settings","Tetapan Akaun") %>
    </button>
</div>
...
<div class="tc-my-profile-tab-content tc-my-profile-tab-visible" id="tab-personal">
    <div class="tc-my-profile-card">
        <div class="tc-my-profile-field">
            <div class="tc-my-profile-field-label"><%: T("Full Name","Nama Penuh") %> *</div>
        ...
        <div class="tc-my-profile-field">
            <div class="tc-my-profile-field-label"><%: T("Teacher ID","ID Guru") %></div>
            <div class="tc-my-profile-field-value">
                <asp:Literal ID="litTID" runat="server" />
            </div>
        </div>
        <div class="tc-my-profile-field">
            <div class="tc-my-profile-field-label"><%: T("Academic Qualification","Kelayakan Akademik") %></div>
            <div class="tc-my-profile-field-value">
                <asp:Literal ID="litQual" runat="server" />
            </div>
        </div>
        <div class="tc-my-profile-field">
        ...
        <div class="tc-my-profile-field">
            ...
            <asp:TextBox ID="txtBio" runat="server"
                TextMode="MultiLine"
                Rows="4"
                CssClass="tc-my-profile-input tc-my-profile-textarea"
                MaxLength="500" />
    ...
    <div class="tc-my-profile-actions">
        <asp:Button ID="btnCancel" runat="server"
            Text="Cancel"
            CssClass="tc-my-profile-btn tc-my-profile-btn-cancel"
            OnClick="btnCancel_Click"
            CausesValidation="false" />
        <asp:Button ID="btnSave" runat="server"
            Text="Save Changes"
            CssClass="tc-my-profile-btn tc-my-profile-btn-primary"
    ...
    <div class="tc-my-profile-card">
        <asp:Panel ID="pnlCertExists" runat="server" Visible="false">
            <div class="tc-my-profile-cert-file">
                <div class="tc-my-profile-cert-icon" id="certIconDiv" runat="server">
                    <i id="certIconI" runat="server" class="bi bi-file-earmark-fill"></i>
                </div>
                <div style="flex:1;">
                    <div class="tc-my-profile-cert-name">
                        <asp:Literal ID="litCertName" runat="server" />
                    </div>
                    <asp:Panel ID="pnlApprovedDate" runat="server" Visible="false">
                        <div class="tc-my-profile-cert-date">
                            <i class="bi bi-calendar-check"></i>
                            <%: T("Approved","Diluluskan") %>: <asp:Literal ID="litApprovedDate" runat="server" />
                        </div>
                    </asp:Panel>
                </div>
                <a id="lnkCert" runat="server" class="tc-my-profile-cert-btn" onclick="openCertModal(event);return false;">
        ...
        <asp:Panel ID="pnlCertEmpty" runat="server" Visible="false">
            <div style="text-align:center;padding:2rem;color:var(--tm);">
                ...
                <p style="font-size:.88rem;margin-top:.6rem;font-weight:600;">
                    <%: T("No teaching certificate uploaded.","Tiada sijil pengajaran dimuat naik.") %>
                </p>
            </div>
        </asp:Panel>
    </div>
...
<div class="tc-my-profile-tab-content" id="tab-settings">
    ...
    <div class="tc-my-profile-card" style="margin-bottom:1.5rem;">
        <div class="tc-my-profile-card-title">
            <i class="bi bi-translate"></i> <%: T("Preferred Language","Bahasa Pilihan") %>
        </div>
        <p style="font-size:.84rem;color:var(--tm);margin:0 0 1rem;line-height:1.5;">
            <%: T("Choose your preferred display language for ScienceBuddy.","Pilih bahasa paparan pilihan anda untuk ScienceBuddy.") %>
        </p>
        <div class="tc-my-profile-field">
        ...
        <div style="margin-top:1rem;">
            <button type="button"
                class="tc-my-profile-btn tc-my-profile-btn-primary"
                style="padding:.6rem 1.4rem;font-size:.84rem;"
                onclick="saveLanguage()">
                <i class="bi bi-check-lg"></i> <%: T("Save Language","Simpan Bahasa") %>
            </button>
        </div>
    </div>
    ...
    <div class="tc-my-profile-card" style="margin-bottom:1.5rem;">
        ...
        <div class="tc-my-profile-field">
            ...
            <div class="tc-my-profile-pw-wrap">
                ...
                <button type="button" class="tc-my-profile-pw-toggle" onclick="togglePw('pwCurrent',this)">
                    <i class="bi bi-eye"></i>
                </button>
            </div>
        </div>
        <div class="tc-my-profile-field">
            ...
            <div class="tc-my-profile-pw-wrap">
                ...
                <button type="button" class="tc-my-profile-pw-toggle" onclick="togglePw('pwNew',this)">
                    <i class="bi bi-eye"></i>
                </button>
            </div>
        </div>
        <div class="tc-my-profile-field">
            ...
            <div class="tc-my-profile-pw-wrap">
                ...
                <button type="button" class="tc-my-profile-pw-toggle" onclick="togglePw('pwConfirm',this)">
                    <i class="bi bi-eye"></i>
                </button>
            </div>
        </div>
        ...
        <div style="margin-top:1.2rem;">
            <button type="button"
                ...
                <i class="bi bi-shield-lock"></i> <%: T("Save Password","Simpan Kata Laluan") %>
            </button>
        </div>
    </div>
    ...
    <div class="tc-my-profile-card tc-my-profile-card-danger">
        <div class="tc-my-profile-card-title" style="color:#B91C1C;">
            <i class="bi bi-exclamation-triangle-fill" style="color:#EF4444;"></i>
            <%: T("Delete Account","Padam Akaun") %>
        </div>
        <p style="font-size:.88rem;color:#6B7280;margin:0 0 1.2rem;line-height:1.6;">
            <%: T("Deleting your account is permanent and cannot be undone.","Pemadaman akaun anda adalah kekal dan tidak boleh dibatalkan.") %>
        </p>
        <button type="button" class="tc-my-profile-btn-delete-account" onclick="openDeleteAccountModal()">
...
<div id="deleteAccountModal" class="tc-manage-quiz-modal-overlay" style="display:none;"
    onclick="if(event.target===this)closeDeleteAccountModal()">
    <div class="tc-manage-quiz-modal" style="max-width:500px;">
        <div class="tc-manage-quiz-modal-header" style="background:#FEF2F2;border-bottom:1px solid #FECACA;">
            <h3 style="color:#B91C1C;display:flex;align-items:center;gap:8px;font-size:1.1rem;">
                <i class="bi bi-exclamation-triangle-fill" style="color:#EF4444;"></i>
                <%: T("Delete Account","Padam Akaun") %>
            </h3>
        ...
        <div class="tc-delete-account-modal-body">
            <p class="tc-delete-account-msg">
                <%: T("We're sorry to see you go. Please tell us why you're leaving before deleting your account.","Kami sedih melihat anda pergi. Sila beritahu kami mengapa anda meninggalkan sebelum memadam akaun anda.") %>
            </p>
            ...
            <div class="tc-delete-account-reasons">
                <label class="tc-delete-account-reason">
                    <input type="radio" name="daReason" value="no_longer_use" />
                    <span><%: T("I no longer use ScienceBuddy","Saya tidak lagi menggunakan ScienceBuddy") %></span>
                </label>
                <label class="tc-delete-account-reason">
                    <input type="radio" name="daReason" value="another_account" />
                    <span><%: T("I created another account","Saya mencipta akaun lain") %></span>
                </label>
                <label class="tc-delete-account-reason">
                    <input type="radio" name="daReason" value="privacy" />
                    <span><%: T("I have privacy concerns","Saya mempunyai kebimbangan privasi") %></span>
                </label>
                <label class="tc-delete-account-reason">
                    <input type="radio" name="daReason" value="technical" />
                    <span><%: T("I am experiencing technical issues","Saya mengalami masalah teknikal") %></span>
                </label>
                <label class="tc-delete-account-reason">
                    <input type="radio" name="daReason" value="not_meet_needs" />
                    <span><%: T("The platform does not meet my needs","Platform ini tidak memenuhi keperluan saya") %></span>
                </label>
                <label class="tc-delete-account-reason">
                    <input type="radio" name="daReason" value="other" />
                    <span><%: T("Other","Lain-lain") %></span>
                </label>
            </div>

            <div id="daOtherWrap" class="tc-delete-account-other-wrap" style="display:none;">
                <textarea id="daOtherText"
                    class="tc-my-profile-input tc-my-profile-textarea"
                    rows="3"
                    placeholder="<%: T("Please share your reason.","Sila kongsi alasan anda.") %>"
        ...
        <div class="tc-manage-quiz-modal-footer">
            <button type="button" class="tc-manage-quiz-btn-cancel" onclick="closeDeleteAccountModal()">
                <%: T("Cancel","Batal") %>
            </button>
            <button type="button" class="tc-my-profile-btn-delete-confirm" onclick="confirmDeleteAccount()">
                <i class="bi bi-trash3"></i> <%: T("Delete Account","Padam Akaun") %>
            </button>
        </div>
    </div>
