...
<asp:Content ID="cPageTitle" ContentPlaceHolderID="PageTitle" runat="server">
    <%: T("Create Practice Quiz","Cipta Kuiz Latihan") %>
</asp:Content>
...
<asp:Panel ID="pnlDenied" runat="server" Visible="false">
    <div class="tc-practice-quiz-denied">
        ...
        <h2 style="color:var(--tc-practice-quiz-text);font-weight:800;">
            <%: T("Access Denied","Akses Ditolak") %>
        </h2>
        <p style="color:var(--tc-practice-quiz-muted);max-width:450px;">
        ...
        <a href="<%: ResolveUrl("~/Teacher/manageQuiz.aspx") %>"
           class="tc-practice-quiz-back"
           style="margin-top:1rem;">
            <i class="bi bi-arrow-left"></i> <%: T("Back","Kembali") %>
        </a>
    </div>
</asp:Panel>
...
<asp:Panel ID="pnlInvalid" runat="server" Visible="false">
    <div class="tc-practice-quiz-denied">
        <div style="font-size:3rem;margin-bottom:1rem;">??</div>
        <h2 style="color:var(--tc-practice-quiz-text);font-weight:800;">
            <%: T("Invalid Selection","Pilihan Tidak Sah") %>
        </h2>
        <p style="color:var(--tc-practice-quiz-muted);max-width:450px;">
            <asp:Literal ID="litInvalidMsg" runat="server" />
        </p>
        <a href="<%: ResolveUrl("~/Teacher/manageQuiz.aspx") %>"
           class="tc-practice-quiz-back"
           style="margin-top:1rem;">
            <i class="bi bi-arrow-left"></i> <%: T("Back to Manage Quizzes","Kembali ke Urus Kuiz") %>
        </a>
    </div>
</asp:Panel>
...
<div class="tc-practice-quiz-hero">
    <div class="tc-practice-quiz-hero-bg">
        <span class="tc-practice-quiz-doodle"
              style="top:12%;right:38%;font-size:2.8rem;transform:rotate(-18deg);color:#A78BFA;">
            <i class="bi bi-rocket-takeoff" style="pointer-events:none;"></i>
        </span>
        <span class="tc-practice-quiz-doodle"
              style="top:8%;right:28%;font-size:2.2rem;transform:rotate(12deg);color:#6D5EF7;">
            <i class="bi bi-lightbulb" style="pointer-events:none;"></i>
        </span>
        <span class="tc-practice-quiz-doodle tc-practice-quiz-doodle-sm"
              style="top:55%;right:22%;font-size:3rem;transform:rotate(-8deg);color:#4F8CFF;">
            <i class="bi bi-book" style="pointer-events:none;"></i>
        </span>
        <span class="tc-practice-quiz-doodle tc-practice-quiz-doodle-sm"
              style="top:20%;right:18%;font-size:2.4rem;transform:rotate(22deg);color:#C4B5FD;">
            <i class="bi bi-eyedropper" style="pointer-events:none;"></i>
        </span>
        <span class="tc-practice-quiz-doodle tc-practice-quiz-doodle-sm"
              style="top:65%;right:42%;font-size:2rem;transform:rotate(-30deg);color:#818CF8;">
            <i class="bi bi-search" style="pointer-events:none;"></i>
        </span>
        <span class="tc-practice-quiz-doodle tc-practice-quiz-doodle-hide"
              style="top:30%;right:8%;font-size:3.5rem;transform:rotate(6deg);color:#A78BFA;">
            <i class="bi bi-globe2" style="pointer-events:none;"></i>
        </span>
        <span class="tc-practice-quiz-doodle tc-practice-quiz-doodle-hide"
              style="top:5%;right:12%;font-size:2rem;transform:rotate(-14deg);color:#60A5FA;">
            <i class="bi bi-diagram-3" style="pointer-events:none;"></i>
        </span>
        <span class="tc-practice-quiz-doodle tc-practice-quiz-doodle-hide"
              style="top:72%;right:14%;font-size:2.6rem;transform:rotate(18deg);color:#C4B5FD;">
            <i class="bi bi-clipboard2-pulse" style="pointer-events:none;"></i>
        </span>
        <span class="tc-practice-quiz-doodle tc-practice-quiz-doodle-hide"
              style="top:45%;right:32%;font-size:2.2rem;transform:rotate(-22deg);color:#93C5FD;">
            <i class="bi bi-thermometer-half" style="pointer-events:none;"></i>
        </span>
        <span class="tc-practice-quiz-doodle tc-practice-quiz-doodle-hide"
              style="top:80%;right:38%;font-size:1.8rem;transform:rotate(10deg);color:#A78BFA;">
            <i class="bi bi-stars" style="pointer-events:none;"></i>
        </span>
        ...
        <svg viewBox="0 0 820 260" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMaxYMid slice">
            ...
            <circle cx="700" cy="170" r="7" fill="#6D5EF7"/>
            <circle cx="726" cy="150" r="5" fill="#4F8CFF"/>
            <circle cx="748" cy="172" r="7" fill="#6D5EF7"/>
            <circle cx="726" cy="192" r="4.5" fill="#A78BFA"/>
    ...
    <div class="tc-practice-quiz-hero-left">
        <div class="tc-practice-quiz-hero-top">
            <div class="tc-practice-quiz-hero-top-left">
                <div class="tc-practice-quiz-hero-icon">
                    <i class="bi bi-pencil-square"></i>
                </div>
                <div>
                    <h1 class="tc-practice-quiz-hero-title">
                        <%: T("Practice Quiz","Kuiz Latihan") %>
                    </h1>
                    <p class="tc-practice-quiz-hero-desc">
                        <%: T("Create questions for the selected learning area.","Cipta soalan untuk kawasan pembelajaran yang dipilih.") %>
                    </p>
                </div>
            </div>
        ...
        <div class="tc-practice-quiz-hero-meta">
            <div class="tc-practice-quiz-meta-item">
                <div class="tc-practice-quiz-meta-pill tc-practice-quiz-meta-pill-level">
                    <i class="bi bi-bar-chart-steps"></i>
                </div>
                <div>
                    <span class="tc-practice-quiz-meta-label"><%: T("Level","Tahap") %></span>
                    <span class="tc-practice-quiz-meta-val" id="heroLevel">
                        <asp:Literal ID="litLevel" runat="server" />
                    </span>
                </div>
            </div>
            <div class="tc-practice-quiz-meta-item">
                <div class="tc-practice-quiz-meta-pill tc-practice-quiz-meta-pill-unit">
                    <i class="bi bi-layers-fill"></i>
                </div>
                <div>
                    <span class="tc-practice-quiz-meta-label"><%: T("Unit","Unit") %></span>
                    <span class="tc-practice-quiz-meta-val" id="heroUnit">
            ...
            <div class="tc-practice-quiz-meta-item">
                <div class="tc-practice-quiz-meta-pill tc-practice-quiz-meta-pill-subtopic">
                    <i class="bi bi-bookmark-fill"></i>
                </div>
                <div>
                    <span class="tc-practice-quiz-meta-label"><%: T("Subtopic","Subtopik") %></span>
                    <span class="tc-practice-quiz-meta-val" id="heroSubtopic">
            ...
            <div class="tc-practice-quiz-meta-item">
                <div class="tc-practice-quiz-meta-pill tc-practice-quiz-meta-pill-lang">
                    <i class="bi bi-translate"></i>
                </div>
                <div>
                    <span class="tc-practice-quiz-meta-label"><%: T("Language","Bahasa") %></span>
                    <span class="tc-practice-quiz-meta-val" id="heroLanguage">
...
<div class="tc-practice-quiz-title-field">
    <label class="tc-practice-quiz-title-label" id="pqTitleLabel">
        <%: T("Quiz Title","Tajuk Kuiz") %> *
    </label>
    <input type="text"
           id="pqTitleInput"
           class="tc-practice-quiz-title-input"
           placeholder="<%: T("Enter quiz title...","Masukkan tajuk kuiz...") %>"
           maxlength="200" />
...
<div class="tc-question-builder-layout">
    ...
    <div class="tc-question-builder-nav">
        <div class="tc-question-builder-nav-header">
            <div class="tc-question-builder-nav-title">
                <%: T("Questions","Soalan") %>
                <span class="tc-question-builder-nav-count" id="navCount">1</span>
            </div>
        </div>
        <div class="tc-question-builder-nav-list" id="qbNavList"></div>
        <div class="tc-question-builder-nav-footer">
            <button type="button"
                    class="tc-question-builder-nav-add"
                    id="pqBtnAdd"
                    onclick="pqAddQuestion()">
                <%: T("+ Add Question","+ Tambah Soalan") %>
            </button>
        </div>
    </div>
    ...
    <div class="tc-question-builder-center">
        ...
        <div class="tc-question-builder-toolbar">
            <div class="tc-question-builder-toolbar-nav">
                <button type="button"
                        id="qbNavPrev"
                        class="tc-question-builder-toolbar-arrow"
                        onclick="pqNavGoTo(window.__PQ_CI-1)">
            ...
            <button type="button"
                    class="tc-question-builder-btn tc-question-builder-btn-success"
                    style="margin:0;padding:.55rem 1.2rem;font-size:.82rem;"
                    onclick="return pqSubmitQuiz()">
                <%: T("Submit Quiz","Hantar Kuiz") %>
            </button>
        </div>
        ...
        <div class="tc-question-builder-editor-body">
            ...
            <div class="tc-question-builder-field" style="margin-bottom:1.2rem;">
                ...
                <div class="tc-question-builder-tc-rte-wrap">
                    <div class="tc-question-builder-tc-rte-toolbar">
                        ...
                        <button type="button"
                                id="pqBtnAddBlank"
                                style="display:none;margin-left:6px;padding:.4rem .8rem;font-size:.76rem;"
                                class="tc-fill-blank-add-btn"
                                onclick="pqAddBlank()">
                ...
                <div id="pqQTextErr" class="tc-question-builder-err-msg" style="display:none;margin-top:6px;">
                    <i class="bi bi-exclamation-circle-fill" style="font-size:13px;flex-shrink:0;"></i>
                    <span id="pqQTextErrMsg"></span>
                </div>
            </div>
            ...
            <div class="tc-question-builder-img-zone" id="pqImgZone">
                <div class="tc-question-builder-img-upload" onclick="document.getElementById('pqImgInput').click()">
                    <div class="tc-question-builder-img-upload-icon">
                        <i class="bi bi-image"></i>
                    </div>
                    <span class="tc-question-builder-img-upload-text">
                ...
                <div class="tc-question-builder-img-preview" id="pqImgPreview">
                    ...
                    <button type="button" class="tc-question-builder-img-remove" onclick="pqRemoveImg()">
                        <i class="bi bi-x"></i>
                    </button>
                </div>
            </div>
            ...
            <div id="pqSectionMCQ" class="tc-question-builder-answer-section">
                <div class="tc-question-builder-section-header">
                    <div class="tc-question-builder-section-header-icon">
                        <i class="bi bi-ui-radios"></i>
                    </div>
                    <span class="tc-question-builder-section-header-text" id="pqOptsLabel">
                        <%: T("Options","Pilihan") %>
                    </span>
                ...
                <div class="tc-question-builder-opts" id="pqMcqOpts">
                    <div class="tc-question-builder-opt">
                        <div class="tc-question-builder-opt-band">A</div>
                        <div class="tc-question-builder-opt-body">
                            <input type="text"
                                   class="tc-question-builder-opt-input tc-practice-quiz-opt-text"
                                   placeholder="<%: T("Enter option A...","Masukkan pilihan A...") %>" />
                        </div>
                        <div class="tc-question-builder-opt-selector" onclick="pqSelectCorrect(this)"></div>
                    </div>
                    <div class="tc-question-builder-opt">
                        ...
                        <div class="tc-question-builder-opt-body">
                            <input type="text"
                                   class="tc-question-builder-opt-input tc-practice-quiz-opt-text"
                                   placeholder="<%: T("Enter option B...","Masukkan pilihan B...") %>" />
                        </div>
                        <div class="tc-question-builder-opt-selector" onclick="pqSelectCorrect(this)"></div>
                    </div>
                    <div class="tc-question-builder-opt">
                        ...
                        <div class="tc-question-builder-opt-body">
                            <input type="text"
                                   class="tc-question-builder-opt-input tc-practice-quiz-opt-text"
                                   placeholder="<%: T("Enter option C...","Masukkan pilihan C...") %>" />
                        </div>
                        <div class="tc-question-builder-opt-selector" onclick="pqSelectCorrect(this)"></div>
                    </div>
                    <div class="tc-question-builder-opt">
                        ...
                        <div class="tc-question-builder-opt-body">
                            <input type="text"
                                   class="tc-question-builder-opt-input tc-practice-quiz-opt-text"
                                   placeholder="<%: T("Enter option D...","Masukkan pilihan D...") %>" />
                        </div>
                        <div class="tc-question-builder-opt-selector" onclick="pqSelectCorrect(this)"></div>
                    </div>
                </div>
                <div id="pqMcqErr" class="tc-question-builder-err-msg" style="display:none;">
                    <i class="bi bi-exclamation-circle-fill" style="font-size:13px;flex-shrink:0;"></i>
                    <span id="pqMcqErrMsg"></span>
                </div>
            </div>
            ...
            <div id="pqSectionTF" class="tc-question-builder-answer-section" style="display:none;">
                ...
                <div class="tc-question-builder-tf-grid">
                    <label class="tc-question-builder-tf-card" id="pqTfTrue">
                        <input type="radio" name="pqTfAnswer" value="A" onchange="pqUpdateTF()"/>
                        <i class="bi bi-check-circle-fill"></i>
                        <span id="pqTfTrueLabel">TRUE</span>
                    </label>
                    <label class="tc-question-builder-tf-card" id="pqTfFalse">
                        <input type="radio" name="pqTfAnswer" value="B" onchange="pqUpdateTF()"/>
                        <i class="bi bi-x-circle-fill"></i>
                        <span id="pqTfFalseLabel">FALSE</span>
                    </label>
                </div>
                <div id="pqTfErr" class="tc-question-builder-err-msg" style="display:none;">
                    <i class="bi bi-exclamation-circle-fill" style="font-size:13px;flex-shrink:0;"></i>
                    <span id="pqTfErrMsg"></span>
                </div>
            </div>
            ...
            <div id="pqSectionMS" class="tc-question-builder-answer-section" style="display:none;">
                <div class="tc-question-builder-section-header">
                    ...
                    <span class="tc-question-builder-ms-count" id="pqMsCount" style="margin-left:0;">
                ...
                <div class="tc-question-builder-opts" id="pqMsOpts">
                    <div class="tc-question-builder-opt tc-question-builder-ms-opt">
                        <div class="tc-question-builder-opt-band">A</div>
                        <div class="tc-question-builder-opt-body">
                            <input type="checkbox" class="tc-practice-quiz-ms-check" onchange="pqUpdateMS()"/>
                            <input type="text"
                                   class="tc-question-builder-opt-input tc-practice-quiz-ms-text"
                                   placeholder="<%: T("Type option A...","Taip pilihan A...") %>" />
                        </div>
                    </div>
                    <div class="tc-question-builder-opt tc-question-builder-ms-opt">
                        <div class="tc-question-builder-opt-band">B</div>
                        <div class="tc-question-builder-opt-body">
                            ...
                            <input type="text"
                                   class="tc-question-builder-opt-input tc-practice-quiz-ms-text"
                                   placeholder="<%: T("Type option B...","Taip pilihan B...") %>" />
                        </div>
                    </div>
                    <div class="tc-question-builder-opt tc-question-builder-ms-opt">
                        <div class="tc-question-builder-opt-band">C</div>
                        <div class="tc-question-builder-opt-body">
                            ...
                            <input type="text"
                                   class="tc-question-builder-opt-input tc-practice-quiz-ms-text"
                                   placeholder="<%: T("Type option C...","Taip pilihan C...") %>" />
                        </div>
                    </div>
                    <div class="tc-question-builder-opt tc-question-builder-ms-opt">
                        <div class="tc-question-builder-opt-band">D</div>
                        <div class="tc-question-builder-opt-body">
                            ...
                            <input type="text"
                                   class="tc-question-builder-opt-input tc-practice-quiz-ms-text"
                                   placeholder="<%: T("Type option D...","Taip pilihan D...") %>" />
                        </div>
                    </div>
                </div>
                <div id="pqMsErr" class="tc-question-builder-err-msg" style="display:none;">
                    <i class="bi bi-exclamation-circle-fill" style="font-size:13px;flex-shrink:0;"></i>
                    <span id="pqMsErrMsg"></span>
                </div>
            </div>
            ...
            <div id="pqSectionFIB" class="tc-question-builder-answer-section" style="display:none;">
                ...
                <div id="pqDndBlankErr" class="tc-question-builder-err-msg" style="display:none;">
                    <i class="bi bi-exclamation-circle-fill" style="font-size:13px;flex-shrink:0;"></i>
                    <span id="pqDndBlankErrMsg"></span>
                </div>
                <div id="pqDndWordsErr" class="tc-question-builder-err-msg" style="display:none;">
                    <i class="bi bi-exclamation-circle-fill" style="font-size:13px;flex-shrink:0;"></i>
                    <span id="pqDndWordsErrMsg"></span>
                </div>
                ...
                <div id="pqFibMappingSection" class="tc-fill-blank-mapping-wrap" style="display:none;">
                    ...
                    <div id="pqDndMapErr" class="tc-question-builder-err-msg" style="display:none;margin-top:6px;">
                        <i class="bi bi-exclamation-circle-fill" style="font-size:13px;flex-shrink:0;"></i>
                        <span id="pqDndMapErrMsg"></span>
                    </div>
                </div>
            ...
            <div class="tc-question-builder-exp-block tc-question-builder-exp-correct">
                <div class="tc-question-builder-exp-block-header">
                    <div class="tc-question-builder-exp-block-icon">
                        <i class="bi bi-check-circle-fill"></i>
                    </div>
                    <span class="tc-question-builder-exp-block-label" id="pqCeLabel">
                        <%: T("Correct Explanation","Penjelasan Betul") %> *
                    </span>
                    <span class="tc-question-builder-exp-block-count" id="pqCeCount">0 / 500</span>
                </div>
                <textarea id="pqTxtCE"
                          class="tc-question-builder-input tc-question-builder-textarea"
                          maxlength="500"
                          placeholder="<%: T("Explain why this answer is correct...","Terangkan mengapa jawapan ini betul...") %>"></textarea>
                <div id="pqCeErr" class="tc-question-builder-err-msg" style="display:none;margin:6px 1.1rem 0;">
                    <i class="bi bi-exclamation-circle-fill" style="font-size:13px;flex-shrink:0;"></i>
                    <span id="pqCeErrMsg"></span>
                </div>
            </div>
            ...
            <div class="tc-question-builder-exp-block tc-question-builder-exp-wrong">
                <div class="tc-question-builder-exp-block-header">
                    ...
                    <span class="tc-question-builder-exp-block-label" id="pqWeLabel">
                        <%: T("Wrong Explanation","Penjelasan Salah") %> *
                    </span>
                ...
                <textarea id="pqTxtWE"
                          class="tc-question-builder-input tc-question-builder-textarea"
                          maxlength="500"
                          placeholder="<%: T("Explain why the other answers are incorrect...","Terangkan mengapa jawapan lain salah...") %>"></textarea>
                <div id="pqWeErr" class="tc-question-builder-err-msg" style="display:none;margin:6px 1.1rem 0;">
                    <i class="bi bi-exclamation-circle-fill" style="font-size:13px;flex-shrink:0;"></i>
                    <span id="pqWeErrMsg"></span>
                </div>
            </div>
    ...
    <div class="tc-question-builder-props">
        <div class="tc-question-builder-props-header">
            <div class="tc-question-builder-props-header-icon">
                <i class="bi bi-sliders"></i>
            </div>
            <div class="tc-question-builder-props-title">
                <%: T("Properties","Sifat") %>
            </div>
        </div>
        <div class="tc-question-builder-props-body">
            <div class="tc-question-builder-prop-field">
                <div class="tc-question-builder-prop-label">
                    <span class="tc-question-builder-prop-label-icon type">
            ...
            <div class="tc-question-builder-prop-field">
                <div class="tc-question-builder-prop-label">
                    <span class="tc-question-builder-prop-label-icon diff">
...
<%-- Modal: Settings --%>
<div id="pqSettingsModal"
     class="tc-practice-quiz-modal-overlay"
     style="display:none;"
    ...
    <div class="tc-practice-quiz-modal">
        ...
        <div class="tc-practice-quiz-modal-body">
            ...
            <div class="tc-practice-quiz-form-row">
                ...
                <select id="stgUnit"
                        class="tc-practice-quiz-form-select"
                        onchange="stgOnUnitChange(this.value)"
                        disabled>
            ...
            <div class="tc-practice-quiz-form-row">
                ...
                <select id="stgSubtopic"
                        class="tc-practice-quiz-form-select"
                        onchange="_stgCheckApply()"
                        disabled>
        ...
        <div class="tc-practice-quiz-modal-footer">
            <button type="button" class="tc-practice-quiz-btn-cancel" onclick="closeSettingsModal()">
                <%: T("Cancel","Batal") %>
            </button>
            <button type="button"
                    id="stgApplyBtn"
                    class="tc-practice-quiz-btn-apply"
                    disabled
                    style="opacity:.5;"
                    onclick="stgApply()">
                <%: T("Apply Changes","Guna Perubahan") %>
            </button>
        </div>
    </div>
</div>
...
<%-- Modal: Confirm Reset --%>
<div id="pqConfirmModal"
     class="tc-practice-quiz-confirm-overlay"
     style="display:none;"
    ...
    <div class="tc-practice-quiz-confirm-modal">
        ...
        <div class="tc-practice-quiz-modal-body">
            <p style="font-size:.88rem;color:#374151;line-height:1.65;margin:0;">
                <%: T("Changing these settings may reset your current unsaved quiz data. Continue?","Menukar tetapan ini mungkin menetapkan semula data kuiz anda yang belum disimpan. Teruskan?") %>
            </p>
        </div>
        <div class="tc-practice-quiz-modal-footer">
            <button type="button" class="tc-practice-quiz-btn-cancel" onclick="closeConfirmModal()">
                <%: T("Cancel","Batal") %>
            </button>
            <button type="button" class="tc-practice-quiz-btn-apply" onclick="stgApplyConfirmed()">
                <%: T("Continue","Teruskan") %>
            </button>
        </div>
    </div>
