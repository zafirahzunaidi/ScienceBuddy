...
<asp:Content ID="cPageTitle" ContentPlaceHolderID="PageTitle" runat="server">
    <%: T("Teacher Dashboard","Papan Pemuka Guru") %>
</asp:Content>
...
<asp:Content ID="cMain" ContentPlaceHolderID="MainContentSidebar" runat="server">
    ...
    <asp:Panel ID="pnlDashboard" runat="server" Visible="false">
            ...
            <div class="tc-dashboard-topics-modal" role="dialog" aria-labelledby="tdTopicsTitle" aria-modal="true">
                <div class="tc-dashboard-topics-header">
                    <div class="tc-dashboard-topics-header-left">
                        <div class="tc-dashboard-topics-header-ico">
                    ...
                    <button type="button"
                        class="tc-dashboard-topics-close"
                ...
                <div class="tc-dashboard-topics-search">
                    <input type="text"
                        id="tdTopicsSearch"
                        placeholder="Search units or subtopics..."
                        oninput="filterTopics(this.value)" />
                </div>
                <div class="tc-dashboard-topics-body" id="tdTopicsBody">
                    <div class="tc-dashboard-topics-loading">
                        <i class="bi bi-arrow-repeat"></i>
                        <span>Loading topics...</span>
                    </div>
                </div>
                <div class="tc-dashboard-topics-footer">
                    <button type="button" class="tc-dashboard-topics-footer-btn" onclick="closeTopicsModal()">
                        Close
                    </button>
                </div>
            </div>
        ...
        <div class="tc-dashboard-sec-hd">
            <div class="tc-dashboard-sec-title">
                <i class="bi bi-mortarboard-fill" style="color:var(--tc-primary);"></i>
                <%: T("Quiz Creation","Cipta Kuiz") %>
            </div>
            <a href="<%: ResolveUrl("~/Teacher/manageQuiz.aspx?tab=unit-level") %>"
        ...
        <div class="tc-dashboard-quiz-row">
            <a href="<%: ResolveUrl("~/Teacher/manageQuiz.aspx?tab=unit-level&type=unit") %>"
                class="tc-dashboard-quiz-card tc-dashboard-quiz-purple">
                <div class="tc-dashboard-quiz-bg-icons">
        ...
        <div class="tc-dashboard-qc-card tc-dashboard-qc-purple">
            ...
            <div class="tc-dashboard-qc-count">
                <span class="tc-dashboard-qc-count-num">
                    <asp:Literal ID="litUnitMyCount" runat="server" Text="0" />
                </span>
                <span class="tc-dashboard-qc-count-of">
                    of <asp:Literal ID="litUnitTotal" runat="server" Text="0" />
                </span>
                <span class="tc-dashboard-qc-count-unit">Questions</span>
            </div>
            <div class="tc-dashboard-qc-bar">
                <div class="tc-dashboard-qc-bar-fill" id="qcBarUnit" style="width:0%;"></div>
            </div>
        </div>
        ...
        <div class="tc-dashboard-qc-card tc-dashboard-qc-blue">
            ...
            <div class="tc-dashboard-qc-count">
                <span class="tc-dashboard-qc-count-num">
                    <asp:Literal ID="litLevelMyCount" runat="server" Text="0" />
                </span>
                <span class="tc-dashboard-qc-count-of">
                    of <asp:Literal ID="litLevelTotal" runat="server" Text="0" />
                </span>
                <span class="tc-dashboard-qc-count-unit">Questions</span>
            </div>
            <div class="tc-dashboard-qc-bar">
                <div class="tc-dashboard-qc-bar-fill" id="qcBarLevel" style="width:0%;"></div>
            </div>
        </div>
        ...
        <div class="tc-dashboard-sec-hd">
            <div class="tc-dashboard-sec-title">
                <i class="bi bi-lightning-fill" style="color:var(--tc-primary);"></i>
                <%: T("Quick Actions","Tindakan Pantas") %>
            </div>
        </div>
        <div class="tc-dashboard-quick">
            <a href="<%: ResolveUrl("~/Teacher/uploadMaterial.aspx") %>" class="tc-dashboard-quick-card">
                <div class="tc-dashboard-quick-ico" style="background:#EDE9FE;color:#6C63FF;">
            ...
            <a href="<%: ResolveUrl("~/Teacher/liveSession.aspx") %>" class="tc-dashboard-quick-card">
                <div class="tc-dashboard-quick-ico" style="background:#DBEAFE;color:#2563EB;">
            ...
            <a href="<%: ResolveUrl("~/Teacher/studentProgress.aspx") %>" class="tc-dashboard-quick-card">
                <div class="tc-dashboard-quick-ico" style="background:#D1FAE5;color:#059669;">
            ...
            <a href="<%: ResolveUrl("~/Teacher/privateMessages.aspx") %>" class="tc-dashboard-quick-card">
                <div class="tc-dashboard-quick-ico" style="background:#FEF3C7;color:#D97706;">
        ...
        <div class="tc-dashboard-twin-row">
            ...
            <div class="tc-dashboard-card" style="flex:1.3;">
                <div class="tc-dashboard-card-body">
                    <div class="tc-dashboard-sec-hd" style="margin-bottom:.75rem;">
                        <div class="tc-dashboard-sec-title" style="font-size:.92rem;">
                            <i class="bi bi-camera-video-fill" style="color:var(--tc-info);"></i>
                            <%: T("Upcoming Live Sessions","Kelas Langsung Akan Datang") %>
                        </div>
                                ...
                                <ItemTemplate>
                                    <div class="tc-dashboard-tl-item">
                                        ...
                                        <div class="tc-dashboard-tl-content">
                                            ...
                                            <div class="tc-dashboard-tl-topic">
                                                <i class="bi bi-bookmark"></i> <%# HttpUtility.HtmlEncode(Eval("topic")) %>
                                            </div>
                                            <div class="tc-dashboard-tl-footer">
                                                <span class='tc-dashboard-tl-badge <%# Eval("badgeCss") %>'><%# Eval("statusLabel") %></span>
                                                <a href='<%# ResolveUrl("~/Teacher/liveSession.aspx") %>'
                                                    class='tc-dashboard-tl-btn <%# Eval("btnCss") %>'>
                                                    <%# Eval("btnLabel") %>
                                                </a>
                                            </div>
                                        </div>
                    ...
                    <asp:Panel ID="pnlTimelineEmpty" runat="server">
                        <div class="tc-dashboard-empty" style="padding:2rem;">
                            ...
                            <div style="font-size:.88rem;font-weight:700;color:var(--tc-text);margin-top:.5rem;">
                                <%: T("No upcoming live sessions.","Tiada kelas langsung akan datang.") %>
                            </div>
                            <div style="font-size:.78rem;color:var(--tc-muted);margin-bottom:.75rem;">
                                <%: T("You're all caught up.","Anda telah selesai.") %>
                            </div>
                            <a href="<%: ResolveUrl("~/Teacher/liveSession.aspx") %>"
                                style="display:inline-flex;align-items:center;gap:5px;padding:.45rem 1rem;border-radius:8px;background:var(--tc-primary);color:#fff;font-size:.78rem;font-weight:700;text-decoration:none;">
                                <i class="bi bi-plus-lg"></i> <%: T("Schedule Session","Jadualkan Sesi") %>
                            </a>
                        </div>
                    </asp:Panel>
                </div>
            ...
            <div class="tc-dashboard-card" style="flex:0.7;">
                <div class="tc-dashboard-card-body">
                    <div class="tc-dashboard-sec-hd" style="margin-bottom:.75rem;">
                        <div class="tc-dashboard-sec-title" style="font-size:.92rem;">
                            <i class="bi bi-bell-fill" style="color:var(--tc-warning);"></i>
                                ...
                                <ItemTemplate>
                                    <div class='tc-dashboard-nv2-item <%# Convert.ToBoolean(Eval("isRead")) ? "" : "unread" %>'>
                                        ...
                                        <div class="tc-dashboard-nv2-body">
                                            ...
                                            <div class="tc-dashboard-nv2-time">
                    ...
                    <asp:Panel ID="pnlDashNotifsEmpty" runat="server">
                        <div class="tc-dashboard-empty" style="padding:2rem;">
                            ...
                            <div style="font-size:.88rem;font-weight:700;color:var(--tc-text);margin-top:.5rem;">
                                <%: T("No new notifications.","Tiada pemberitahuan baharu.") %>
                            </div>
                            <div style="font-size:.78rem;color:var(--tc-muted);">
                                <%: T("You're all caught up.","Anda telah selesai.") %>
                            </div>
                        </div>
                    </asp:Panel>
        ...
        <div class="tc-dashboard-sec-hd">
            <div class="tc-dashboard-sec-title">
                <i class="bi bi-bar-chart-fill" style="color:var(--tc-primary);"></i>
                <%: T("Overview","Ringkasan") %>
            </div>
        </div>
        <div class="tc-dashboard-stats">
            <a href="#" class="tc-dashboard-stat tc-dashboard-stat-lessons">
                <div class="tc-dashboard-stat-icon" style="background:#EDE9FE;color:#6C63FF;">
                    <i class="bi bi-file-earmark-text-fill"></i>
                </div>
                <div class="tc-dashboard-stat-val">
                    <asp:Literal ID="litTotalLessons" runat="server" Text="0" />
                </div>
            ...
            <a href="#" class="tc-dashboard-stat tc-dashboard-stat-quizzes">
                <div class="tc-dashboard-stat-icon" style="background:#FEF3C7;color:#D97706;">
                    <i class="bi bi-patch-question-fill"></i>
                </div>
                <div class="tc-dashboard-stat-val">
                    <asp:Literal ID="litTotalQuizzes" runat="server" Text="0" />
                </div>
                <div class="tc-dashboard-stat-lbl"><%: T("Total Quizzes","Jumlah Kuiz") %></div>
            </a>
            <a href="#" class="tc-dashboard-stat tc-dashboard-stat-sessions">
                <div class="tc-dashboard-stat-icon" style="background:#DBEAFE;color:#2563EB;">
                    <i class="bi bi-camera-video-fill"></i>
                </div>
                <div class="tc-dashboard-stat-val">
                    <asp:Literal ID="litUpcomingSessions" runat="server" Text="0" />
                </div>
            ...
            <a href="#" class="tc-dashboard-stat tc-dashboard-stat-students">
                <div class="tc-dashboard-stat-icon" style="background:#D1FAE5;color:#059669;">
        ...
        <%-- -- 6. PRACTICE QUIZ ENGAGEMENT -- --%>
        <div class="tc-dashboard-sec-hd">
            <div class="tc-dashboard-sec-title">
                <i class="bi bi-clipboard2-pulse-fill" style="color:var(--tc-primary);"></i>
                Practice Quiz Engagement
            </div>
        </div>
        <p style="font-size:.82rem;color:var(--tc-muted);margin-top:-.5rem;margin-bottom:1.25rem;">
            Track student participation and performance for each of your approved practice quizzes.
        </p>

        <asp:Panel ID="pnlPQCards" runat="server" Visible="false">
            <div class="tc-dashboard-pq-carousel-wrap">
                <button type="button"
                    class="tc-dashboard-pq-arrow tc-dashboard-pq-arrow-left disabled"
                    id="pqArrowLeft"
                    onclick="pqSlide(-1)">
                    <i class="bi bi-chevron-left"></i>
                </button>
                <button type="button"
                    class="tc-dashboard-pq-arrow tc-dashboard-pq-arrow-right"
                    id="pqArrowRight"
                    onclick="pqSlide(1)">
                                ...
                                <div class="tc-dashboard-pq-slide">
                                    <div class="tc-dashboard-pq-card">
                                        <div class="tc-dashboard-pq-card-top">
                                            <span class="tc-dashboard-pq-badge-top tc-dashboard-pq-badge-questions">
                                                <%# Eval("questionCount") %> Questions
                                            </span>
                                            <span class="tc-dashboard-pq-badge-top tc-dashboard-pq-badge-lang-top">
                                                <%# Eval("langLabel") %>
                                            </span>
                                        </div>
                                        <div class="tc-dashboard-pq-card-body">
                                            <div class="tc-dashboard-pq-title">
                                            ...
                                            <div class="tc-dashboard-pq-info-row">
                                                <div class="tc-dashboard-pq-info-item">
                                                    ...
                                                    <div>
                                                        <div class="tc-dashboard-pq-info-label">Level</div>
                                                        <div class="tc-dashboard-pq-info-value">
                                                ...
                                                <div class="tc-dashboard-pq-info-item">
                                                    ...
                                                    <div>
                                                        <div class="tc-dashboard-pq-info-label">Subtopic</div>
                                                        <div class="tc-dashboard-pq-info-value">
                                                            <%# HttpUtility.HtmlEncode(Eval("subtopicName")) %>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tc-dashboard-pq-metrics">
                                                <div class="tc-dashboard-pq-metric">
                                                    <div class="tc-dashboard-pq-metric-ico" style="background:#EDE9FE;color:#6C63FF;">
                                                        <i class="bi bi-people-fill"></i>
                                                    </div>
                                                    <div class="tc-dashboard-pq-metric-text">
                                                        <div class="tc-dashboard-pq-metric-val"><%# Eval("studentsAttempted") %></div>
                                                        <div class="tc-dashboard-pq-metric-lbl">Students Attempted</div>
                                                    </div>
                                                </div>
                                                <div class="tc-dashboard-pq-metric">
                                                    <div class="tc-dashboard-pq-metric-ico" style="background:#DBEAFE;color:#2563EB;">
                                                        <i class="bi bi-arrow-repeat"></i>
                                                    </div>
                                                    <div class="tc-dashboard-pq-metric-text">
                                                        <div class="tc-dashboard-pq-metric-val"><%# Eval("totalAttempts") %></div>
                                                        <div class="tc-dashboard-pq-metric-lbl">Total Attempts</div>
                                                    </div>
                                                </div>
                                                <div class="tc-dashboard-pq-metric">
                                                    <div class="tc-dashboard-pq-metric-ico" style="background:#D1FAE5;color:#059669;">
                                                        <i class="bi bi-trophy-fill"></i>
                                                    </div>
                                                    <div class="tc-dashboard-pq-metric-text">
                                                        <div class="tc-dashboard-pq-metric-val"><%# Eval("avgScore") %></div>
                                                        <div class="tc-dashboard-pq-metric-lbl">Average Score</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <asp:Panel ID="pnlPQEmpty" runat="server">
            <div class="tc-dashboard-pq-empty">
                ...
                <div class="tc-dashboard-pq-empty-sub">
                    Your approved Practice Quiz engagement will appear here once a quiz has been approved.
                </div>
            </div>
        </asp:Panel>
...
<script>
    ...
    document.addEventListener('keydown', function (e) {
        if (e.key === 'Escape' && document.getElementById('tdTopicsOverlay').classList.contains('open'))
            closeTopicsModal();
    });
    ...
    function renderTopics(data) {
        var body = document.getElementById('tdTopicsBody');
        if (!data || !data.length) {
            body.innerHTML = '<div class="tc-dashboard-topics-empty"><div class="tc-dashboard-topics-empty-ico"><i class="bi bi-journal-x"></i></div><div class="tc-dashboard-topics-empty-title">No topics available</div><div class="tc-dashboard-topics-empty-sub">Topics will appear here once added.</div></div>';
            return;
        }
        ...
        for (var i = 0; i < levels.length; i++) {
            ...
            for (var j = 0; j < units.length; j++) {
                ...
                if (show && q) {
                    ...
                    unit.querySelector('.tc-dashboard-unit-header').classList.add('open');
                }
            ...
            if ((levelMatch || levelNameMatch) && q) {
                level.classList.add('open');
                level.querySelector('.tc-dashboard-level-header').classList.add('open');
            }
            if (!q) {
                level.classList.remove('open');
                level.querySelector('.tc-dashboard-level-header').classList.remove('open');
                var us = level.querySelectorAll('.tc-dashboard-unit-item');
                for (var m = 0; m < us.length; m++) {
                    us[m].classList.remove('open');
                    us[m].querySelector('.tc-dashboard-unit-header').classList.remove('open');
                }
            }
        }
    ...
    (function () {
        ...
        function render() {
            ...
            if (left) {
                if (idx <= 0) left.classList.add('disabled');
                else left.classList.remove('disabled');
            }
            if (right) {
                if (idx >= maxIdx) right.classList.add('disabled');
