<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateDiscussion.aspx.cs"
    Inherits="ScienceBuddy.Parent.CreateDiscussion" MasterPageFile="~/Site.Master"
    Title="Create Discussion" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="cPageTitle" ContentPlaceHolderID="PageTitle" runat="server"><%: T("Create Discussion","Buat Perbincangan") %></asp:Content>
...
<div class="pd-page">
    ...
    <div class="pt-study-plan-header"><div class="pt-study-plan-header-left"><h2 class="pt-study-plan-title"><i class="bi bi-chat-square-text"></i> <%: T("Create Discussion","Buat Perbincangan") %></h2></div>
    ...
    <div class="pt-profile-section">
        ...
        <div class="pt-field"><label class="pt-label"><%: T("Tags (optional)","Tag (pilihan)") %></label>
            <asp:TextBox ID="txtTags" runat="server" CssClass="pt-input" placeholder="Type tags separated by commas, e.g. Magnets, Homework, Quiz Help" />
            <div class="pt-tag-suggestions"><asp:Literal ID="litTagSuggestions" runat="server" /></div>
        </div>
        <asp:Button ID="btnSubmit" runat="server" CssClass="pt-btn primary" OnClick="BtnSubmit_Click" CausesValidation="false" />
    </div>
</div>
</asp:Content>
