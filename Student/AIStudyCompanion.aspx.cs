...
{
    public partial class AIStudyCompanion : Page
    {
        // ── Connection string ─────────────────────────────────────────
        ...
        private void LoadPage()
        {
            using (var conn = new SqlConnection(ConnStr))
            {
                ...
                if (totalAttempts > 0 || hasAnalysis)
                {
                    ...
                    {
                        litStrongTopics.Text = "<span class='ai-chip ai-chip--green'>—</span>";
                    ...
                    {
                        litWeakTopics.Text = "<span class='ai-chip ai-chip--orange'>—</span>";
        ...
        private string FormatChips(string topics, string color)
        {
            ...
            string cssClass = color == "green" ? "ai-chip ai-chip--green" : "ai-chip ai-chip--orange";
