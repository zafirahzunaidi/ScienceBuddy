...
{
    public partial class MagneticForcesExplorer : Page
    {
        ...
        {
            string labId = Request.QueryString["labId"] ?? "LAB001";
            ...
            using (var conn = new SqlConnection(ConnStr))
            {
                ...
                if (Tbl("LabProgress"))
                {
                    ...
                    { cmd.Parameters.AddWithValue("@s", _studentId); cmd.Parameters.AddWithValue("@l", labId);
                      ...
                      if (r != null && Convert.ToBoolean(r)) { btnComplete.Enabled = false; btnComplete.Text = T("âœ“ Completed","âœ“ Selesai");
        ...
        private void SetLabels()
        {
            ...
            litStep1Title.Text = T("Step 1: Test Magnet Poles","Langkah 1: Uji Kutub Magnet");
            litStep1Inst.Text = T("Click a pole combination to see if the magnets attract or repel.",
                "Klik gabungan kutub untuk melihat sama ada magnet menarik atau menolak.");
            litStep2Title.Text = T("Step 2: Sort Objects","Langkah 2: Susun Objek");
            litStep2Inst.Text = T("Click an object, then click the correct bucket (Magnetic or Non-Magnetic).",
                "Klik objek, kemudian klik baldi yang betul (Magnetik atau Bukan Magnetik).");
            litMagnetic.Text = T("Magnetic","Magnetik");
            litNonMagnetic.Text = T("Non-Magnetic","Bukan Magnetik");
            litObjNail.Text = T("Nail","Paku");
            litObjClip.Text = T("Paperclip","Klip Kertas");
            litObjCoin.Text = T("Coin","Syiling");
            litObjPencil.Text = T("Pencil","Pensil");
            litObjEraser.Text = T("Eraser","Pemadam");
            litObjRuler.Text = T("Plastic Ruler","Pembaris Plastik");
