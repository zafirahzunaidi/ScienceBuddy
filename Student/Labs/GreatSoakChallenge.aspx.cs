...
{
    public partial class GreatSoakChallenge : Page
    {
        ...
        {
            string labId = Request.QueryString["labId"] ?? "LAB002";
        ...
        private void SetLabels()
        {
            ...
            litStep1Title.Text = T("Step 1: Test Absorption", "Langkah 1: Uji Penyerapan");
            litStep1Inst.Text = T("Click a material, then click the dropper 3 times to test how much water it absorbs.",
                "Klik bahan, kemudian klik penitis 3 kali untuk menguji berapa banyak air yang diserap.");
            litStep2Title.Text = T("Step 2: Compare & Pick", "Langkah 2: Bandingkan & Pilih");
            litStep2Inst.Text = T("Which material absorbs the most water? Click the most absorbent one!",
                "Bahan mana yang paling banyak menyerap air? Klik bahan yang paling menyerap!");
            litMatSponge.Text = T("Sponge", "Span");
            litMatTissue.Text = T("Tissue", "Tisu");
        ...
        protected void btnComplete_Click(object sender, EventArgs e)
        {
            ...
            using (var conn = new SqlConnection(ConnStr))
            {
                ...
                {
                    using (var cmd = new SqlCommand("UPDATE LabProgress SET isCompleted=1,completedDate=@dt WHERE studentId=@s AND labId=@l", conn))
                    {
