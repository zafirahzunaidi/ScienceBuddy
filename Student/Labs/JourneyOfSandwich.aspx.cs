...
namespace ScienceBuddy.Student.Labs
{
    public partial class JourneyOfSandwich : Page
    {
        ...
        {
            string labId = Request.QueryString["labId"] ?? "LAB003";
        ...
        private void SetLabels()
        {
            ...
            litStep1Title.Text = T("Step 1: Follow the Journey", "Langkah 1: Ikuti Perjalanan");
            litStep1Inst.Text = T("Click each stage to learn what happens to your sandwich. Go through all 6 stages!",
                "Klik setiap peringkat untuk belajar apa yang berlaku kepada sandwic anda. Ikuti semua 6 peringkat!");
            litStep2Title.Text = T("Step 2: Quiz Time!", "Langkah 2: Masa Kuiz!");
            litStep2Inst.Text = T("Answer 3 questions about the digestive system.",
                "Jawab 3 soalan tentang sistem pencernaan.");
            litStage0.Text = T("Mouth", "Mulut");
            litStage1.Text = T("Esophagus", "Esofagus");
            litStage2.Text = T("Stomach", "Perut");
            litStage3.Text = T("Small Intestine", "Usus Kecil");
            litStage4.Text = T("Large Intestine", "Usus Besar");
            litStage5.Text = T("Anus", "Anus");
            litNextBtn.Text = T("Next â†’", "Seterusnya â†’");
