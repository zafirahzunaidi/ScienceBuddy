...
{
    public partial class BloodFlowSimulator : Page
    {
        ...
        {
            string labId = Request.QueryString["labId"] ?? "LAB006";
        ...
        private void SetLabels()
        {
            ...
            litStep1Title.Text = T("Step 1: Trace the Blood Flow Path", "Langkah 1: Jejak Laluan Aliran Darah");
            litStep1Inst.Text = T("Click each node in the correct order to trace how blood flows: Lungs ? Heart ? Body ? Heart ? Lungs.",
                "Klik setiap nod mengikut urutan yang betul untuk menjejak aliran darah: Paru-paru ? Jantung ? Badan ? Jantung ? Paru-paru.");
            litStep2Title.Text = T("Step 2: Blood Flow Quiz", "Langkah 2: Kuiz Aliran Darah");
            litStep2Inst.Text = T("Answer these questions about blood circulation and oxygen transport.",
                "Jawab soalan tentang peredaran darah dan pengangkutan oksigen.");
            litOxyRich.Text = T("Oxygen-rich (Red)", "Kaya Oksigen (Merah)");
            litCO2Rich.Text = T("CO2-rich (Blue)", "Kaya CO2 (Biru)");
            litNode1.Text = T("Lungs", "Paru-paru");
            litNode2.Text = T("Heart", "Jantung");
            litNode3.Text = T("Body", "Badan");
            litNode4.Text = T("Heart", "Jantung");
            litNode5.Text = T("Lungs", "Paru-paru");
