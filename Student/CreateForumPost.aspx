...
.cfp-header::before{content:'💬';position:absolute;font-size:6rem;opacity:.07;
    top:-10px;right:40px;pointer-events:none;line-height:1;}
...
.cfp-header-sub{font-size:.95rem;opacity:.88;position:relative;z-index:1;max-width:500px;line-height:1.5;}
...
<div class="cfp-form">
    ...
    <div class="cfp-form-group">
        <label class="cfp-form-label"><asp:Literal ID="litTitleLbl" runat="server" Text="Discussion Title" /></label>
    ...
    <%-- Message --%>
    <div class="cfp-form-group">
        <label class="cfp-form-label"><asp:Literal ID="litMsgLbl" runat="server" Text="Your Message" /></label>
