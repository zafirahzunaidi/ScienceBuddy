...
<asp:Content ID="cMain" ContentPlaceHolderID="MainContentSidebar" runat="server">
    ...
    <div class="st-lesson-nav">
        ...
        <asp:LinkButton ID="btnFinish" runat="server" CssClass="st-lesson-nav-btn st-lesson-nav-next" Visible="false" OnClick="btnFinish_Click">
            <i class="bi bi-check-circle"></i> <asp:Literal ID="litFinishBtn" runat="server" Text="Finish Lesson" />
        </asp:LinkButton>
    </div>
