...
namespace ScienceBuddy.Student
{
    public partial class PersonalityTest : Page
    {
        ...
        private void SetLabels()
        {
            ...
            litS1L.Text = T("Slow & Steady", "Perlahan & Mantap"); litS1R.Text = T("Fast & Bold", "Pantas & Berani");
            litS2.Text = T("Learning Focus", "Fokus Pembelajaran");
            litS2L.Text = T("Goals & Rewards", "Matlamat & Ganjaran"); litS2R.Text = T("Explore & Create", "Terokai & Cipta");
            litS3.Text = T("Thinking Style", "Gaya Berfikir");
            litS3L.Text = T("Quick Answer", "Jawapan Pantas"); litS3R.Text = T("Deep Explanation", "Penerangan Mendalam");
            litS4.Text = T("Learning Mood", "Suasana Belajar");
            litS4L.Text = T("Calm", "Tenang"); litS4R.Text = T("Energetic", "Bertenaga");
            litS5.Text = T("Study Preference", "Pilihan Belajar");
            litS5L.Text = T("Learn Alone", "Belajar Sendiri"); litS5R.Text = T("Learn Together", "Belajar Bersama");
            litS6.Text = T("Activity Style", "Gaya Aktiviti");
            litS6L.Text = T("Read Notes", "Baca Nota"); litS6R.Text = T("Do Activities", "Buat Aktiviti");
        ...
        {
            InitLang();
            int s1 = GetSlider("slider1"); int s2 = GetSlider("slider2"); int s3 = GetSlider("slider3");
            int s4 = GetSlider("slider4"); int s5 = GetSlider("slider5"); int s6 = GetSlider("slider6");
            ...
            if (gogetter > max) { max = gogetter; pid = "P004"; pName = "Go-Getter"; }
            ...
            {
                cmd.Parameters.AddWithValue("@p", pid); cmd.Parameters.AddWithValue("@u", userId);
        ...
        private void ShowResult(string pid, string pName)
        {
            ...
            switch (pid)
            {
                case "P001": avatar += "achiever.png"; pName = "Achiever";
                    ...
                    card3 = T("Complete missions one by one", "Selesaikan misi satu demi satu"); break;
                case "P002": avatar += "creative.png"; pName = "Creative";
                    ...
                    card3 = T("Use colours, diagrams & experiments", "Guna warna, rajah & eksperimen"); break;
                case "P003": avatar += "thinker.png"; pName = "Thinker";
                    ...
                    card3 = T("Understand the reason behind each answer", "Fahami sebab setiap jawapan"); break;
                case "P004": avatar += "gogetter.png"; pName = "Go-Getter";
                    ...
                    card3 = T("Challenge yourself and retry", "Cabar diri anda dan cuba lagi"); break;
                case "P005": avatar += "chill-learner.png"; pName = "Chill Learner";
                    ...
                    card3 = T("Learn calmly at your own pace", "Belajar dengan tenang mengikut rentak anda"); break;
                case "P006": avatar += "socializer.png"; pName = "Socializer";
                    ...
                    card3 = T("Ask questions & learn together", "Tanya soalan & belajar bersama"); break;
            }
            imgResult.ImageUrl = ResolveUrl(avatar);
            litResultName.Text = HttpUtility.HtmlEncode(pName);
            litResultDesc.Text = desc;
            litCard1Title.Text = c1Title; litCard1Val.Text = card1;
            litCard2Title.Text = c2Title; litCard2Val.Text = card2;
            litCard3Title.Text = c3Title; litCard3Val.Text = card3;
        }

        private int GetSlider(string name)
        {
            string val = Request.Form[name];
            int v; return int.TryParse(val, out v) ? Math.Max(1, Math.Min(5, v)) : 3;
        }
    }
}
