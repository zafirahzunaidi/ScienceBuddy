<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UnitDetails.aspx.cs" Inherits="ScienceBuddy.Student.UnitDetails1" %>
    ...
    <asp:Repeater ID="rptSubtopics" runat="server">
        <ItemTemplate>
            <div class="st-unitdetails-subtopic">
                ...
                <div class="st-unitdetails-lessons">
                    <asp:Repeater ID="rptLessons" runat="server" DataSource='<%# Eval("Lessons") %>'>
                        <ItemTemplate>
                            <div class="st-unitdetails-lesson">
                                <div class="st-unitdetails-lesson-icon <%# (bool)Eval("Done") ? "done" : "pending" %>">
