    ...
    public partial class SystemActivityLogs : Page
    {
        ...
        private string TranslateAction(string action)
        {
            ...
            switch (action)
            {
                ...
                case "Password Change": return "Tukar Kata Laluan";
                case "Profile Update": return "Kemaskini Profil";
        ...
        private string TranslateDescription(string desc)
        {
            ...
            switch (desc)
            {
                ...
                case "User password changed successfully.": return "Kata laluan pengguna berjaya ditukar.";
                case "User profile updated successfully.": return "Profil pengguna berjaya dikemaskini.";
                default: return desc;
            }
        }
