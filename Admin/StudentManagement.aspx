...
<div class="ad-student-management-add-field"><label class="ad-student-management-add-label"><%= T("Full Name *","Nama Penuh *") %></label><input id="s_name" class="ad-student-management-add-input" type="text" /><div class="ad-student-management-add-err" id="e_name"><%= T("Full name is required.","Nama penuh diperlukan.") %></div></div>
<div class="ad-student-management-add-field"><label class="ad-student-management-add-label"><%= T("Username *","Nama Pengguna *") %></label><input id="s_username" class="ad-student-management-add-input" type="text" /><div class="ad-student-management-add-err" id="e_username"><%= T("Username is required.","Nama pengguna diperlukan.") %></div></div>
<div class="ad-student-management-add-field"><label class="ad-student-management-add-label"><%= T("Email *","E-mel *") %></label><input id="s_email" class="ad-student-management-add-input" type="email" placeholder="example@email.com" /><div class="ad-student-management-add-err" id="e_email"><%= T("Enter a valid email address (e.g. example@email.com)","Masukkan alamat e-mel yang sah (cth: example@email.com)") %></div></div>
<div class="ad-student-management-add-field"><label class="ad-student-management-add-label"><%= T("Phone *","Telefon *") %></label><input id="s_phone" class="ad-student-management-add-input" type="tel" placeholder="01X-XXXXXXX" maxlength="12" /><div class="ad-student-management-add-err" id="e_phone"><%= T("Enter a valid Malaysian phone number (e.g. 012-3456789)","Masukkan nombor telefon Malaysia yang sah (cth: 012-3456789)") %></div></div>
...
<div class="ad-student-management-add-field"><label class="ad-student-management-add-label"><%= T("Confirm Password *","Sahkan Kata Laluan *") %></label><input id="s_pw2" class="ad-student-management-add-input" type="password" /><div class="ad-student-management-add-err" id="e_pw2"><%= T("Passwords do not match.","Kata laluan tidak sama.") %></div></div>
...
function submitAddStudent(){
    ...
    if(!e||!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)){document.getElementById('e_email').style.display='block';document.getElementById('s_email').classList.add('error');ok=false;}
    if(!ph){document.getElementById('e_phone').style.display='block';document.getElementById('s_phone').classList.add('error');ok=false;}
    else{var phoneRegex=/^01[0-9]-?\d{7,8}$/;if(!phoneRegex.test(ph.replace(/\s/g,''))){document.getElementById('e_phone').style.display='block';document.getElementById('s_phone').classList.add('error');ok=false;}}
