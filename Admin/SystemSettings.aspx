...
<asp:Content ID="cSidebar" ContentPlaceHolderID="SidebarMenu" runat="server">
    ...
    <div class="sb-nav-section">
        ...
        <a href="<%: ResolveUrl("~/Admin/CertificateManagement.aspx") %>" class="sb-sidebar-item">
            ...
            <span class="item-label"><%= T("Certificates", "Sijil") %></span>
        </a>
    </div>
    <div class="sb-nav-section">
        ...
        <a href="<%: ResolveUrl("~/Admin/ForumDiscussions.aspx") %>" class="sb-sidebar-item">
            ...
            <span class="item-label"><%= T("Forum Discussions", "Perbincangan Forum") %></span>
        </a>
    </div>
    <div class="sb-nav-section">
        <div class="sb-nav-section-label"><%= T("Gamification", "Gamifikasi") %></div>
        <a href="<%: ResolveUrl("~/Admin/GamificationManagement.aspx") %>" class="sb-sidebar-item">
            <i class="bi bi-trophy item-icon"></i>
            <span class="item-label"><%= T("Student Performance", "Prestasi Pelajar") %></span>
        </a>
    </div>
    <div class="sb-nav-section">
        <div class="sb-nav-section-label"><%= T("Configuration", "Konfigurasi") %></div>
        <a href="<%: ResolveUrl("~/Admin/SystemSettings.aspx") %>" class="sb-sidebar-item active">
            <i class="bi bi-gear item-icon"></i>
            <span class="item-label"><%= T("System Settings", "Tetapan Sistem") %></span>
        </a>
    </div>
    <div class="sb-nav-section">
        <div class="sb-nav-section-label"><%= T("Logs", "Log") %></div>
        <a href="<%: ResolveUrl("~/Admin/SystemActivityLogs.aspx") %>" class="sb-sidebar-item">
            <i class="bi bi-clock-history item-icon"></i>
            <span class="item-label"><%= T("Activity Logs", "Log Aktiviti") %></span>
        </a>
        <a href="<%: ResolveUrl("~/Admin/LoginLogs.aspx") %>" class="sb-sidebar-item">
            <i class="bi bi-box-arrow-in-right item-icon"></i>
            <span class="item-label"><%= T("Login Logs", "Log Log Masuk") %></span>
        </a>
        <a href="<%: ResolveUrl("~/Admin/SuspiciousLogins.aspx") %>" class="sb-sidebar-item">
            <i class="bi bi-exclamation-triangle item-icon"></i>
            <span class="item-label"><%= T("Suspicious Logins", "Log Masuk Mencurigakan") %></span>
        </a>
    </div>
    <div class="sb-nav-section">
...
<div class="ad-system-settings-section" data-section="quiz">
    ...
    <div class="ad-system-settings-sec-body">
        <!-- CONFIG001 -->
        <div class="ad-system-settings-card cat-quiz" data-id="CONFIG001" data-search="passing mark percentage unit peratusan lulus">
            ...
            <div class="ad-system-settings-card-value"><input type="number" id="val_CONFIG001" value="<%= GetVal("CONFIG001") %>" data-orig="<%= GetVal("CONFIG001") %>" oninput="detectChange(this)" min="1" max="100" /><span class="ad-system-settings-card-unit">%</span></div>
        ...
        <!-- CONFIG002 -->
        <div class="ad-system-settings-card cat-quiz" data-id="CONFIG002" data-search="passing mark level peratusan lulus tahap">
            ...
            <div class="ad-system-settings-card-value"><input type="number" id="val_CONFIG002" value="<%= GetVal("CONFIG002") %>" data-orig="<%= GetVal("CONFIG002") %>" oninput="detectChange(this)" min="1" max="100" /><span class="ad-system-settings-card-unit">%</span></div>
        ...
        <!-- CONFIG004 -->
        <div class="ad-system-settings-card cat-quiz" data-id="CONFIG004" data-search="easy question mark markah soalan mudah">
            ...
            <div class="ad-system-settings-card-value"><input type="number" id="val_CONFIG004" value="<%= GetVal("CONFIG004") %>" data-orig="<%= GetVal("CONFIG004") %>" oninput="detectChange(this)" min="1" /><span class="ad-system-settings-card-unit"><%= T("Marks", "Markah") %></span></div>
        ...
        <!-- CONFIG005 -->
        <div class="ad-system-settings-card cat-quiz" data-id="CONFIG005" data-search="medium question mark markah soalan sederhana">
            ...
            <div class="ad-system-settings-card-value"><input type="number" id="val_CONFIG005" value="<%= GetVal("CONFIG005") %>" data-orig="<%= GetVal("CONFIG005") %>" oninput="detectChange(this)" min="1" /><span class="ad-system-settings-card-unit"><%= T("Marks", "Markah") %></span></div>
        ...
        <!-- CONFIG006 -->
        <div class="ad-system-settings-card cat-quiz" data-id="CONFIG006" data-search="hard question mark markah soalan sukar">
            ...
            <div class="ad-system-settings-card-value"><input type="number" id="val_CONFIG006" value="<%= GetVal("CONFIG006") %>" data-orig="<%= GetVal("CONFIG006") %>" oninput="detectChange(this)" min="1" /><span class="ad-system-settings-card-unit"><%= T("Marks", "Markah") %></span></div>
            <div class="ad-system-settings-card-bottom"><span class="ad-system-settings-card-ts"><i class="bi bi-clock"></i> <%= GetUpdated("CONFIG006") %></span><div class="ad-system-settings-card-btns"><a class="ad-system-settings-cbtn ad-system-settings-cbtn-reset" onclick="resetCard(this)" href="javascript:;"><i class="bi bi-arrow-counterclockwise"></i> Reset</a><a class="ad-system-settings-cbtn ad-system-settings-cbtn-save cat-quiz" onclick="saveCard('CONFIG006')" href="javascript:;"><i class="bi bi-floppy"></i> <%= T("Save", "Simpan") %></a></div></div>
        </div>
    </div>
</div>
...
<div class="ad-system-settings-section" data-section="sec">
    ...
    <div class="ad-system-settings-sec-body">
        <!-- CONFIG007 -->
        <div class="ad-system-settings-card cat-sec" data-id="CONFIG007" data-search="suspicious login attempt percubaan log masuk mencurigakan">
            ...
            <div class="ad-system-settings-card-value"><input type="number" id="val_CONFIG007" value="<%= GetVal("CONFIG007") %>" data-orig="<%= GetVal("CONFIG007") %>" oninput="detectChange(this)" min="1" /><span class="ad-system-settings-card-unit"><%= T("Attempts", "Percubaan") %></span></div>
            <div class="ad-system-settings-card-bottom"><span class="ad-system-settings-card-ts"><i class="bi bi-clock"></i> <%= GetUpdated("CONFIG007") %></span><div class="ad-system-settings-card-btns"><a class="ad-system-settings-cbtn ad-system-settings-cbtn-reset" onclick="resetCard(this)" href="javascript:;"><i class="bi bi-arrow-counterclockwise"></i> Reset</a><a class="ad-system-settings-cbtn ad-system-settings-cbtn-save cat-sec" onclick="saveCard('CONFIG007')" href="javascript:;"><i class="bi bi-floppy"></i> <%= T("Save", "Simpan") %></a></div></div>
        </div>
        <!-- CONFIG008 -->
        <div class="ad-system-settings-card cat-sec" data-id="CONFIG008" data-search="account lock duration minutes tempoh kunci akaun minit">
            ...
            <div class="ad-system-settings-card-value"><input type="number" id="val_CONFIG008" value="<%= GetVal("CONFIG008") %>" data-orig="<%= GetVal("CONFIG008") %>" oninput="detectChange(this)" min="1" /><span class="ad-system-settings-card-unit"><%= T("Minutes", "Minit") %></span></div>
            <div class="ad-system-settings-card-bottom"><span class="ad-system-settings-card-ts"><i class="bi bi-clock"></i> <%= GetUpdated("CONFIG008") %></span><div class="ad-system-settings-card-btns"><a class="ad-system-settings-cbtn ad-system-settings-cbtn-reset" onclick="resetCard(this)" href="javascript:;"><i class="bi bi-arrow-counterclockwise"></i> Reset</a><a class="ad-system-settings-cbtn ad-system-settings-cbtn-save cat-sec" onclick="saveCard('CONFIG008')" href="javascript:;"><i class="bi bi-floppy"></i> <%= T("Save", "Simpan") %></a></div></div>
        </div>
        <!-- CONFIG009 -->
        <div class="ad-system-settings-card cat-sec" data-id="CONFIG009" data-search="password minimum length panjang minimum kata laluan characters aksara">
            ...
            <div class="ad-system-settings-card-value"><input type="number" id="val_CONFIG009" value="<%= GetVal("CONFIG009") %>" data-orig="<%= GetVal("CONFIG009") %>" oninput="detectChange(this)" min="1" /><span class="ad-system-settings-card-unit"><%= T("Characters", "Aksara") %></span></div>
            <div class="ad-system-settings-card-bottom"><span class="ad-system-settings-card-ts"><i class="bi bi-clock"></i> <%= GetUpdated("CONFIG009") %></span><div class="ad-system-settings-card-btns"><a class="ad-system-settings-cbtn ad-system-settings-cbtn-reset" onclick="resetCard(this)" href="javascript:;"><i class="bi bi-arrow-counterclockwise"></i> Reset</a><a class="ad-system-settings-cbtn ad-system-settings-cbtn-save cat-sec" onclick="saveCard('CONFIG009')" href="javascript:;"><i class="bi bi-floppy"></i> <%= T("Save", "Simpan") %></a></div></div>
        </div>
    </div>
</div>
...
<div class="ad-system-settings-section" data-section="gam">
    ...
    <div class="ad-system-settings-sec-body">
        <!-- CONFIG003 -->
        <div class="ad-system-settings-card cat-gam" data-id="CONFIG003" data-search="leaderboard top count bilangan teratas papan markah students pelajar">
            ...
            <div class="ad-system-settings-card-value"><input type="number" id="val_CONFIG003" value="<%= GetVal("CONFIG003") %>" data-orig="<%= GetVal("CONFIG003") %>" oninput="detectChange(this)" min="1" /><span class="ad-system-settings-card-unit"><%= T("Students", "Pelajar") %></span></div>
            <div class="ad-system-settings-card-bottom"><span class="ad-system-settings-card-ts"><i class="bi bi-clock"></i> <%= GetUpdated("CONFIG003") %></span><div class="ad-system-settings-card-btns"><a class="ad-system-settings-cbtn ad-system-settings-cbtn-reset" onclick="resetCard(this)" href="javascript:;"><i class="bi bi-arrow-counterclockwise"></i> Reset</a><a class="ad-system-settings-cbtn ad-system-settings-cbtn-save cat-gam" onclick="saveCard('CONFIG003')" href="javascript:;"><i class="bi bi-floppy"></i> <%= T("Save", "Simpan") %></a></div></div>
        </div>
    </div>
</div>
...
<div class="ad-system-settings-section" data-section="live">
    ...
    <div class="ad-system-settings-sec-body">
        <!-- CONFIG010 -->
        <div class="ad-system-settings-card cat-live" data-id="CONFIG010" data-search="maximum students per session maksimum pelajar setiap sesi">
            ...
            <div class="ad-system-settings-card-value"><input type="number" id="val_CONFIG010" value="<%= GetVal("CONFIG010") %>" data-orig="<%= GetVal("CONFIG010") %>" oninput="detectChange(this)" min="1" /><span class="ad-system-settings-card-unit"><%= T("Students", "Pelajar") %></span></div>
            <div class="ad-system-settings-card-bottom"><span class="ad-system-settings-card-ts"><i class="bi bi-clock"></i> <%= GetUpdated("CONFIG010") %></span><div class="ad-system-settings-card-btns"><a class="ad-system-settings-cbtn ad-system-settings-cbtn-reset" onclick="resetCard(this)" href="javascript:;"><i class="bi bi-arrow-counterclockwise"></i> Reset</a><a class="ad-system-settings-cbtn ad-system-settings-cbtn-save cat-live" onclick="saveCard('CONFIG010')" href="javascript:;"><i class="bi bi-floppy"></i> <%= T("Save", "Simpan") %></a></div></div>
        </div>
        <!-- CONFIG011 -->
        <div class="ad-system-settings-card cat-live" data-id="CONFIG011" data-search="consultation session duration minutes tempoh sesi konsultasi minit">
            ...
            <div class="ad-system-settings-card-bottom"><span class="ad-system-settings-card-ts"><i class="bi bi-clock"></i> <%= GetUpdated("CONFIG011") %></span><div class="ad-system-settings-card-btns"><a class="ad-system-settings-cbtn ad-system-settings-cbtn-reset" onclick="resetCard(this)" href="javascript:;"><i class="bi bi-arrow-counterclockwise"></i> Reset</a><a class="ad-system-settings-cbtn ad-system-settings-cbtn-save cat-live" onclick="saveCard('CONFIG011')" href="javascript:;"><i class="bi bi-floppy"></i> <%= T("Save", "Simpan") %></a></div></div>
        </div>
    </div>
</div>
