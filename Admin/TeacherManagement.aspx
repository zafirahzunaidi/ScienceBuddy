...
<asp:Content ID="cSidebar" ContentPlaceHolderID="SidebarMenu" runat="server">
    ...
    <div class="sb-nav-section"><div class="sb-nav-section-label"><%= T("User Management", "Pengurusan Pengguna") %></div>
        ...
        <a href="<%: ResolveUrl("~/Admin/TeacherManagement.aspx") %>" class="sb-sidebar-item active"><i class="bi bi-person-badge item-icon"></i><span class="item-label"><%= T("Teachers", "Guru") %></span></a>
    ...
    <div class="sb-nav-section"><div class="sb-nav-section-label"><%= T("Learning Content", "Kandungan Pembelajaran") %></div>
        ...
        <a href="<%: ResolveUrl("~/Admin/QuestionRequests.aspx") %>" class="sb-sidebar-item"><i class="bi bi-clipboard-check item-icon"></i><span class="item-label"><%= T("Quiz Requests", "Permintaan Kuiz") %></span></a>
...
<div class="ad-teacher-management-add-field"><label class="ad-teacher-management-add-label"><%= T("Full Name *","Nama Penuh *") %></label><input id="t_name" class="ad-teacher-management-add-input" type="text" /><div class="ad-teacher-management-add-err" id="te_name"><%= T("Full name is required.","Nama penuh diperlukan.") %></div></div>
<div class="ad-teacher-management-add-field"><label class="ad-teacher-management-add-label"><%= T("Username *","Nama Pengguna *") %></label><input id="t_username" class="ad-teacher-management-add-input" type="text" /><div class="ad-teacher-management-add-err" id="te_username"><%= T("Username is required.","Nama pengguna diperlukan.") %></div></div>
<div class="ad-teacher-management-add-field"><label class="ad-teacher-management-add-label"><%= T("Email *","E-mel *") %></label><input id="t_email" class="ad-teacher-management-add-input" type="email" placeholder="example@email.com" /><div class="ad-teacher-management-add-err" id="te_email"><%= T("Enter a valid email address (e.g. example@email.com)","Masukkan alamat e-mel yang sah (cth: example@email.com)") %></div></div>
<div class="ad-teacher-management-add-field"><label class="ad-teacher-management-add-label"><%= T("Phone Number *","Nombor Telefon *") %></label><input id="t_phone" class="ad-teacher-management-add-input" type="tel" placeholder="01X-XXXXXXX" maxlength="12" /><div class="ad-teacher-management-add-err" id="te_phone"><%= T("Enter a valid Malaysian phone number (e.g. 012-3456789)","Masukkan nombor telefon Malaysia yang sah (cth: 012-3456789)") %></div></div>
...
function submitAddTeacher(){
    ...
    if(!e||!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)){document.getElementById('te_email').style.display='block';document.getElementById('t_email').classList.add('error');ok=false;}
    if(!ph){document.getElementById('te_phone').style.display='block';document.getElementById('t_phone').classList.add('error');ok=false;}
    else{var phoneRegex=/^01[0-9]-?\d{7,8}$/;if(!phoneRegex.test(ph.replace(/\s/g,''))){document.getElementById('te_phone').style.display='block';document.getElementById('t_phone').classList.add('error');ok=false;}}
