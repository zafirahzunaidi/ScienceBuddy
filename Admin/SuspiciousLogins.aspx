...
<asp:Content ID="cSidebar" ContentPlaceHolderID="SidebarMenu" runat="server">
    ...
    <div class="sb-nav-section"><div class="sb-nav-section-label"><%= T("Logs", "Log") %></div>
        ...
        <a href="<%: ResolveUrl("~/Admin/SuspiciousLogins.aspx") %>" class="sb-sidebar-item active"><i class="bi bi-exclamation-triangle item-icon"></i><span class="item-label"><%= T("Suspicious Logins", "Log Masuk Mencurigakan") %></span></a>
    </div>
