...
<asp:Content ID="cSidebar" ContentPlaceHolderID="SidebarMenu" runat="server">
    ...
    <div class="sb-nav-section"><div class="sb-nav-section-label"><%= T("Account", "Akaun") %></div>
        ...
        <a href="<%: ResolveUrl("~/Admin/Profile.aspx") %>" class="sb-sidebar-item active"><i class="bi bi-person item-icon"></i><span class="item-label"><%= T("My Profile", "Profil Saya") %></span></a>
...
(function () {
    ...
    window.confirmSave = function () {
        ...
        // Hide the edit modal so SweetAlert appears on top
        var modal = document.getElementById('editModal');
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // Re-show the edit modal if cancelled
    ...
    window.confirmChangePwd = function () {
        ...
        // Hide the change password modal so SweetAlert appears on top
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // Re-show the modal if cancelled
                if (modal) modal.classList.add('active');
            }
        });
    };
