...
<asp:Content ID="cSidebar" ContentPlaceHolderID="SidebarMenu" runat="server">
    ...
    <div class="sb-nav-section"><div class="sb-nav-section-label"><%= T("Logs", "Log") %></div>
        ...
        <a href="<%: ResolveUrl("~/Admin/LoginLogs.aspx") %>" class="sb-sidebar-item active"><i class="bi bi-box-arrow-in-right item-icon"></i><span class="item-label"><%= T("Login Logs", "Log Log Masuk") %></span></a>
